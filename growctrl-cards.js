var gt=globalThis,mt=gt.ShadowRoot&&(gt.ShadyCSS===void 0||gt.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,wt=Symbol(),ue=new WeakMap,st=class{constructor(e,t,i){if(this._$cssResult$=!0,i!==wt)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=e,this.t=t}get styleSheet(){let e=this.o,t=this.t;if(mt&&e===void 0){let i=t!==void 0&&t.length===1;i&&(e=ue.get(t)),e===void 0&&((this.o=e=new CSSStyleSheet).replaceSync(this.cssText),i&&ue.set(t,e))}return e}toString(){return this.cssText}},he=a=>new st(typeof a=="string"?a:a+"",void 0,wt),rt=(a,...e)=>{let t=a.length===1?a[0]:e.reduce((i,n,s)=>i+(r=>{if(r._$cssResult$===!0)return r.cssText;if(typeof r=="number")return r;throw Error("Value passed to 'css' function must be a 'css' function result: "+r+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(n)+a[s+1],a[0]);return new st(t,a,wt)},ge=(a,e)=>{if(mt)a.adoptedStyleSheets=e.map(t=>t instanceof CSSStyleSheet?t:t.styleSheet);else for(let t of e){let i=document.createElement("style"),n=gt.litNonce;n!==void 0&&i.setAttribute("nonce",n),i.textContent=t.cssText,a.appendChild(i)}},_t=mt?a=>a:a=>a instanceof CSSStyleSheet?(e=>{let t="";for(let i of e.cssRules)t+=i.cssText;return he(t)})(a):a;var{is:Ke,defineProperty:je,getOwnPropertyDescriptor:qe,getOwnPropertyNames:Xe,getOwnPropertySymbols:Ye,getPrototypeOf:Qe}=Object,ft=globalThis,me=ft.trustedTypes,Je=me?me.emptyScript:"",ti=ft.reactiveElementPolyfillSupport,at=(a,e)=>a,kt={toAttribute(a,e){switch(e){case Boolean:a=a?Je:null;break;case Object:case Array:a=a==null?a:JSON.stringify(a)}return a},fromAttribute(a,e){let t=a;switch(e){case Boolean:t=a!==null;break;case Number:t=a===null?null:Number(a);break;case Object:case Array:try{t=JSON.parse(a)}catch{t=null}}return t}},be=(a,e)=>!Ke(a,e),fe={attribute:!0,type:String,converter:kt,reflect:!1,useDefault:!1,hasChanged:be};Symbol.metadata??=Symbol("metadata"),ft.litPropertyMetadata??=new WeakMap;var N=class extends HTMLElement{static addInitializer(e){this._$Ei(),(this.l??=[]).push(e)}static get observedAttributes(){return this.finalize(),this._$Eh&&[...this._$Eh.keys()]}static createProperty(e,t=fe){if(t.state&&(t.attribute=!1),this._$Ei(),this.prototype.hasOwnProperty(e)&&((t=Object.create(t)).wrapped=!0),this.elementProperties.set(e,t),!t.noAccessor){let i=Symbol(),n=this.getPropertyDescriptor(e,i,t);n!==void 0&&je(this.prototype,e,n)}}static getPropertyDescriptor(e,t,i){let{get:n,set:s}=qe(this.prototype,e)??{get(){return this[t]},set(r){this[t]=r}};return{get:n,set(r){let l=n?.call(this);s?.call(this,r),this.requestUpdate(e,l,i)},configurable:!0,enumerable:!0}}static getPropertyOptions(e){return this.elementProperties.get(e)??fe}static _$Ei(){if(this.hasOwnProperty(at("elementProperties")))return;let e=Qe(this);e.finalize(),e.l!==void 0&&(this.l=[...e.l]),this.elementProperties=new Map(e.elementProperties)}static finalize(){if(this.hasOwnProperty(at("finalized")))return;if(this.finalized=!0,this._$Ei(),this.hasOwnProperty(at("properties"))){let t=this.properties,i=[...Xe(t),...Ye(t)];for(let n of i)this.createProperty(n,t[n])}let e=this[Symbol.metadata];if(e!==null){let t=litPropertyMetadata.get(e);if(t!==void 0)for(let[i,n]of t)this.elementProperties.set(i,n)}this._$Eh=new Map;for(let[t,i]of this.elementProperties){let n=this._$Eu(t,i);n!==void 0&&this._$Eh.set(n,t)}this.elementStyles=this.finalizeStyles(this.styles)}static finalizeStyles(e){let t=[];if(Array.isArray(e)){let i=new Set(e.flat(1/0).reverse());for(let n of i)t.unshift(_t(n))}else e!==void 0&&t.push(_t(e));return t}static _$Eu(e,t){let i=t.attribute;return i===!1?void 0:typeof i=="string"?i:typeof e=="string"?e.toLowerCase():void 0}constructor(){super(),this._$Ep=void 0,this.isUpdatePending=!1,this.hasUpdated=!1,this._$Em=null,this._$Ev()}_$Ev(){this._$ES=new Promise(e=>this.enableUpdating=e),this._$AL=new Map,this._$E_(),this.requestUpdate(),this.constructor.l?.forEach(e=>e(this))}addController(e){(this._$EO??=new Set).add(e),this.renderRoot!==void 0&&this.isConnected&&e.hostConnected?.()}removeController(e){this._$EO?.delete(e)}_$E_(){let e=new Map,t=this.constructor.elementProperties;for(let i of t.keys())this.hasOwnProperty(i)&&(e.set(i,this[i]),delete this[i]);e.size>0&&(this._$Ep=e)}createRenderRoot(){let e=this.shadowRoot??this.attachShadow(this.constructor.shadowRootOptions);return ge(e,this.constructor.elementStyles),e}connectedCallback(){this.renderRoot??=this.createRenderRoot(),this.enableUpdating(!0),this._$EO?.forEach(e=>e.hostConnected?.())}enableUpdating(e){}disconnectedCallback(){this._$EO?.forEach(e=>e.hostDisconnected?.())}attributeChangedCallback(e,t,i){this._$AK(e,i)}_$ET(e,t){let i=this.constructor.elementProperties.get(e),n=this.constructor._$Eu(e,i);if(n!==void 0&&i.reflect===!0){let s=(i.converter?.toAttribute!==void 0?i.converter:kt).toAttribute(t,i.type);this._$Em=e,s==null?this.removeAttribute(n):this.setAttribute(n,s),this._$Em=null}}_$AK(e,t){let i=this.constructor,n=i._$Eh.get(e);if(n!==void 0&&this._$Em!==n){let s=i.getPropertyOptions(n),r=typeof s.converter=="function"?{fromAttribute:s.converter}:s.converter?.fromAttribute!==void 0?s.converter:kt;this._$Em=n;let l=r.fromAttribute(t,s.type);this[n]=l??this._$Ej?.get(n)??l,this._$Em=null}}requestUpdate(e,t,i,n=!1,s){if(e!==void 0){let r=this.constructor;if(n===!1&&(s=this[e]),i??=r.getPropertyOptions(e),!((i.hasChanged??be)(s,t)||i.useDefault&&i.reflect&&s===this._$Ej?.get(e)&&!this.hasAttribute(r._$Eu(e,i))))return;this.C(e,t,i)}this.isUpdatePending===!1&&(this._$ES=this._$EP())}C(e,t,{useDefault:i,reflect:n,wrapped:s},r){i&&!(this._$Ej??=new Map).has(e)&&(this._$Ej.set(e,r??t??this[e]),s!==!0||r!==void 0)||(this._$AL.has(e)||(this.hasUpdated||i||(t=void 0),this._$AL.set(e,t)),n===!0&&this._$Em!==e&&(this._$Eq??=new Set).add(e))}async _$EP(){this.isUpdatePending=!0;try{await this._$ES}catch(t){Promise.reject(t)}let e=this.scheduleUpdate();return e!=null&&await e,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){if(!this.isUpdatePending)return;if(!this.hasUpdated){if(this.renderRoot??=this.createRenderRoot(),this._$Ep){for(let[n,s]of this._$Ep)this[n]=s;this._$Ep=void 0}let i=this.constructor.elementProperties;if(i.size>0)for(let[n,s]of i){let{wrapped:r}=s,l=this[n];r!==!0||this._$AL.has(n)||l===void 0||this.C(n,void 0,s,l)}}let e=!1,t=this._$AL;try{e=this.shouldUpdate(t),e?(this.willUpdate(t),this._$EO?.forEach(i=>i.hostUpdate?.()),this.update(t)):this._$EM()}catch(i){throw e=!1,this._$EM(),i}e&&this._$AE(t)}willUpdate(e){}_$AE(e){this._$EO?.forEach(t=>t.hostUpdated?.()),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(e)),this.updated(e)}_$EM(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$ES}shouldUpdate(e){return!0}update(e){this._$Eq&&=this._$Eq.forEach(t=>this._$ET(t,this[t])),this._$EM()}updated(e){}firstUpdated(e){}};N.elementStyles=[],N.shadowRootOptions={mode:"open"},N[at("elementProperties")]=new Map,N[at("finalized")]=new Map,ti?.({ReactiveElement:N}),(ft.reactiveElementVersions??=[]).push("2.1.2");var Lt=globalThis,xe=a=>a,bt=Lt.trustedTypes,ve=bt?bt.createPolicy("lit-html",{createHTML:a=>a}):void 0,Se="$lit$",U=`lit$${Math.random().toFixed(9).slice(2)}$`,Ae="?"+U,ei=`<${Ae}>`,j=document,lt=()=>j.createComment(""),ct=a=>a===null||typeof a!="object"&&typeof a!="function",Pt=Array.isArray,ii=a=>Pt(a)||typeof a?.[Symbol.iterator]=="function",St=`[ 	
\f\r]`,ot=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,ye=/-->/g,$e=/>/g,G=RegExp(`>|${St}(?:([^\\s"'>=/]+)(${St}*=${St}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),we=/'/g,_e=/"/g,Ee=/^(?:script|style|textarea|title)$/i,Tt=a=>(e,...t)=>({_$litType$:a,strings:e,values:t}),o=Tt(1),X=Tt(2),Ri=Tt(3),q=Symbol.for("lit-noChange"),u=Symbol.for("lit-nothing"),ke=new WeakMap,K=j.createTreeWalker(j,129);function Ce(a,e){if(!Pt(a)||!a.hasOwnProperty("raw"))throw Error("invalid template strings array");return ve!==void 0?ve.createHTML(e):e}var ni=(a,e)=>{let t=a.length-1,i=[],n,s=e===2?"<svg>":e===3?"<math>":"",r=ot;for(let l=0;l<t;l++){let c=a[l],p,d,m=-1,f=0;for(;f<c.length&&(r.lastIndex=f,d=r.exec(c),d!==null);)f=r.lastIndex,r===ot?d[1]==="!--"?r=ye:d[1]!==void 0?r=$e:d[2]!==void 0?(Ee.test(d[2])&&(n=RegExp("</"+d[2],"g")),r=G):d[3]!==void 0&&(r=G):r===G?d[0]===">"?(r=n??ot,m=-1):d[1]===void 0?m=-2:(m=r.lastIndex-d[2].length,p=d[1],r=d[3]===void 0?G:d[3]==='"'?_e:we):r===_e||r===we?r=G:r===ye||r===$e?r=ot:(r=G,n=void 0);let x=r===G&&a[l+1].startsWith("/>")?" ":"";s+=r===ot?c+ei:m>=0?(i.push(p),c.slice(0,m)+Se+c.slice(m)+U+x):c+U+(m===-2?l:x)}return[Ce(a,s+(a[t]||"<?>")+(e===2?"</svg>":e===3?"</math>":"")),i]},pt=class a{constructor({strings:e,_$litType$:t},i){let n;this.parts=[];let s=0,r=0,l=e.length-1,c=this.parts,[p,d]=ni(e,t);if(this.el=a.createElement(p,i),K.currentNode=this.el.content,t===2||t===3){let m=this.el.content.firstChild;m.replaceWith(...m.childNodes)}for(;(n=K.nextNode())!==null&&c.length<l;){if(n.nodeType===1){if(n.hasAttributes())for(let m of n.getAttributeNames())if(m.endsWith(Se)){let f=d[r++],x=n.getAttribute(m).split(U),$=/([.?@])?(.*)/.exec(f);c.push({type:1,index:s,name:$[2],strings:x,ctor:$[1]==="."?Et:$[1]==="?"?Ct:$[1]==="@"?zt:J}),n.removeAttribute(m)}else m.startsWith(U)&&(c.push({type:6,index:s}),n.removeAttribute(m));if(Ee.test(n.tagName)){let m=n.textContent.split(U),f=m.length-1;if(f>0){n.textContent=bt?bt.emptyScript:"";for(let x=0;x<f;x++)n.append(m[x],lt()),K.nextNode(),c.push({type:2,index:++s});n.append(m[f],lt())}}}else if(n.nodeType===8)if(n.data===Ae)c.push({type:2,index:s});else{let m=-1;for(;(m=n.data.indexOf(U,m+1))!==-1;)c.push({type:7,index:s}),m+=U.length-1}s++}}static createElement(e,t){let i=j.createElement("template");return i.innerHTML=e,i}};function Q(a,e,t=a,i){if(e===q)return e;let n=i!==void 0?t._$Co?.[i]:t._$Cl,s=ct(e)?void 0:e._$litDirective$;return n?.constructor!==s&&(n?._$AO?.(!1),s===void 0?n=void 0:(n=new s(a),n._$AT(a,t,i)),i!==void 0?(t._$Co??=[])[i]=n:t._$Cl=n),n!==void 0&&(e=Q(a,n._$AS(a,e.values),n,i)),e}var At=class{constructor(e,t){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){let{el:{content:t},parts:i}=this._$AD,n=(e?.creationScope??j).importNode(t,!0);K.currentNode=n;let s=K.nextNode(),r=0,l=0,c=i[0];for(;c!==void 0;){if(r===c.index){let p;c.type===2?p=new dt(s,s.nextSibling,this,e):c.type===1?p=new c.ctor(s,c.name,c.strings,this,e):c.type===6&&(p=new Ft(s,this,e)),this._$AV.push(p),c=i[++l]}r!==c?.index&&(s=K.nextNode(),r++)}return K.currentNode=j,n}p(e){let t=0;for(let i of this._$AV)i!==void 0&&(i.strings!==void 0?(i._$AI(e,i,t),t+=i.strings.length-2):i._$AI(e[t])),t++}},dt=class a{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(e,t,i,n){this.type=2,this._$AH=u,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=i,this.options=n,this._$Cv=n?.isConnected??!0}get parentNode(){let e=this._$AA.parentNode,t=this._$AM;return t!==void 0&&e?.nodeType===11&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=Q(this,e,t),ct(e)?e===u||e==null||e===""?(this._$AH!==u&&this._$AR(),this._$AH=u):e!==this._$AH&&e!==q&&this._(e):e._$litType$!==void 0?this.$(e):e.nodeType!==void 0?this.T(e):ii(e)?this.k(e):this._(e)}O(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}T(e){this._$AH!==e&&(this._$AR(),this._$AH=this.O(e))}_(e){this._$AH!==u&&ct(this._$AH)?this._$AA.nextSibling.data=e:this.T(j.createTextNode(e)),this._$AH=e}$(e){let{values:t,_$litType$:i}=e,n=typeof i=="number"?this._$AC(e):(i.el===void 0&&(i.el=pt.createElement(Ce(i.h,i.h[0]),this.options)),i);if(this._$AH?._$AD===n)this._$AH.p(t);else{let s=new At(n,this),r=s.u(this.options);s.p(t),this.T(r),this._$AH=s}}_$AC(e){let t=ke.get(e.strings);return t===void 0&&ke.set(e.strings,t=new pt(e)),t}k(e){Pt(this._$AH)||(this._$AH=[],this._$AR());let t=this._$AH,i,n=0;for(let s of e)n===t.length?t.push(i=new a(this.O(lt()),this.O(lt()),this,this.options)):i=t[n],i._$AI(s),n++;n<t.length&&(this._$AR(i&&i._$AB.nextSibling,n),t.length=n)}_$AR(e=this._$AA.nextSibling,t){for(this._$AP?.(!1,!0,t);e!==this._$AB;){let i=xe(e).nextSibling;xe(e).remove(),e=i}}setConnected(e){this._$AM===void 0&&(this._$Cv=e,this._$AP?.(e))}},J=class{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(e,t,i,n,s){this.type=1,this._$AH=u,this._$AN=void 0,this.element=e,this.name=t,this._$AM=n,this.options=s,i.length>2||i[0]!==""||i[1]!==""?(this._$AH=Array(i.length-1).fill(new String),this.strings=i):this._$AH=u}_$AI(e,t=this,i,n){let s=this.strings,r=!1;if(s===void 0)e=Q(this,e,t,0),r=!ct(e)||e!==this._$AH&&e!==q,r&&(this._$AH=e);else{let l=e,c,p;for(e=s[0],c=0;c<s.length-1;c++)p=Q(this,l[i+c],t,c),p===q&&(p=this._$AH[c]),r||=!ct(p)||p!==this._$AH[c],p===u?e=u:e!==u&&(e+=(p??"")+s[c+1]),this._$AH[c]=p}r&&!n&&this.j(e)}j(e){e===u?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e??"")}},Et=class extends J{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===u?void 0:e}},Ct=class extends J{constructor(){super(...arguments),this.type=4}j(e){this.element.toggleAttribute(this.name,!!e&&e!==u)}},zt=class extends J{constructor(e,t,i,n,s){super(e,t,i,n,s),this.type=5}_$AI(e,t=this){if((e=Q(this,e,t,0)??u)===q)return;let i=this._$AH,n=e===u&&i!==u||e.capture!==i.capture||e.once!==i.once||e.passive!==i.passive,s=e!==u&&(i===u||n);n&&this.element.removeEventListener(this.name,this,i),s&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){typeof this._$AH=="function"?this._$AH.call(this.options?.host??this.element,e):this._$AH.handleEvent(e)}},Ft=class{constructor(e,t,i){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=i}get _$AU(){return this._$AM._$AU}_$AI(e){Q(this,e)}};var si=Lt.litHtmlPolyfillSupport;si?.(pt,dt),(Lt.litHtmlVersions??=[]).push("3.3.3");var ze=(a,e,t)=>{let i=t?.renderBefore??e,n=i._$litPart$;if(n===void 0){let s=t?.renderBefore??null;i._$litPart$=n=new dt(e.insertBefore(lt(),s),s,void 0,t??{})}return n._$AI(a),n};var Mt=globalThis,B=class extends N{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){let e=super.createRenderRoot();return this.renderOptions.renderBefore??=e.firstChild,e}update(e){let t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Do=ze(t,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return q}};B._$litElement$=!0,B.finalized=!0,Mt.litElementHydrateSupport?.({LitElement:B});var ri=Mt.litElementPolyfillSupport;ri?.({LitElement:B});(Mt.litElementVersions??=[]).push("4.2.2");var h={label:"rgba(242,247,243,0.56)",value:"rgba(242,247,243,0.97)",muted:"rgba(242,247,243,0.46)",logLabel:"rgba(242,247,243,0.72)",logText:"rgba(242,247,243,0.90)",ok:"#7BE8A8",warn:"#FFCE7A",crit:"#FF9D9D",info:"#9AC8FF",water:"#7CC8F0",light:"#FFDC8A",temp:"#FFB98A",heat:"#FFB35C",tileBg:"rgba(255,255,255,0.04)",rowBg:"rgba(255,255,255,0.035)"},Ot={critical:"rgba(255,157,157,.14)",warning:"rgba(255,206,122,.12)",info:"rgba(154,200,255,.10)",ok:h.rowBg,none:"rgba(255,255,255,.022)"},Fe={critical:h.crit,warning:h.warn,info:h.info,ok:h.logText,none:"rgba(242,247,243,.36)"},Rt={Aus:{bg:"rgba(150,170,160,0.12)",color:"#8EA89C"},Seedling:{bg:"rgba(154,200,255,0.16)",color:"#9AC8FF"},Veg:{bg:"rgba(123,232,168,0.16)",color:"#7BE8A8"},Bloom:{bg:"rgba(255,185,138,0.18)",color:"#FFB98A"},Flush:{bg:"rgba(195,171,245,0.18)",color:"#C3ABF5"},Trocknung:{bg:"rgba(211,168,120,0.18)",color:"#D3A878"}},Bt={soft_garden:{label:"Soft Garden (Standard)",top:"#202C25",card:"#1B2620",card2:"#222F28",card3:"#17211B",line:"#2E3D34",lineSoft:"#27342C",tx:"#F2F7F3",tx2:"#B9CCC0",tx3:"#85998C"},graphite:{label:"Graphite",top:"#20242A",card:"#191C21",card2:"#232830",card3:"#15181C",line:"#313842",lineSoft:"#2A3038",tx:"#F2F4F7",tx2:"#C2C8D0",tx3:"#8A919B"},midnight:{label:"Midnight",top:"#1A2233",card:"#141A28",card2:"#1E2740",card3:"#111626",line:"#2B3958",lineSoft:"#25304A",tx:"#EFF3FB",tx2:"#BCC8DE",tx3:"#8492AC"},plum:{label:"Plum",top:"#241F2E",card:"#1B1726",card2:"#261F36",card3:"#16121F",line:"#382E4A",lineSoft:"#2F273E",tx:"#F4F0FA",tx2:"#C9C0D8",tx3:"#978AA8"},terra:{label:"Terra",top:"#2A2420",card:"#201A16",card2:"#2C2420",card3:"#1A1410",line:"#3D332B",lineSoft:"#332A24",tx:"#F7F3EF",tx2:"#D0C8C0",tx3:"#9B918A"},slate_teal:{label:"Slate Teal",top:"#1C2A2A",card:"#142020",card2:"#1E2E2E",card3:"#111A1A",line:"#2B4040",lineSoft:"#243434",tx:"#EFF7F6",tx2:"#BCD2D0",tx3:"#84A09E"},rose_noir:{label:"Ros\xE9 Noir",top:"#2A1F24",card:"#201619",card2:"#2C1F25",card3:"#1A1216",line:"#3D2B33",lineSoft:"#33242B",tx:"#FAF0F3",tx2:"#D8C0C8",tx3:"#A88A95"},ink:{label:"Ink",top:"#1A1C1E",card:"#131517",card2:"#1D2023",card3:"#0F1113",line:"#2C3137",lineSoft:"#252A2F",tx:"#F4F6F8",tx2:"#C4CACF",tx3:"#8B9298"}},ai=a=>{if(!a||a==="soft_garden")return"";let e=Bt[a];return e?[`--gc-bg:linear-gradient(180deg, ${e.top}, ${e.card} 30%)`,`--card:${e.card}`,`--card-2:${e.card2}`,`--card-3:${e.card3}`,`--line:${e.line}`,`--line-soft:${e.lineSoft}`,`--tx:${e.tx}`,`--tx-2:${e.tx2}`,`--tx-3:${e.tx3}`].join(";"):""},L=a=>{let e=[],t=ai(a?.palette);if(t&&e.push(t),a?.background){let i=a.background.trim(),n=i.includes(",")&&!/^(linear|radial|conic|rgb|hsl)/i.test(i)?`linear-gradient(160deg, ${i})`:i;e.push(`--gc-bg:${n}`)}return a?.opacity!==void 0&&e.push(`--gc-opacity:${a.opacity}`),a?.accent&&e.push(`--gc-accent:${a.accent}`),a?.radius!==void 0&&e.push(`--gc-radius:${a.radius}px`),e.join(";")},tt=a=>a.includes("critical")?"critical":a.includes("warning")?"warning":a.includes("info")?"info":"ok",D=a=>({ok:"ok",info:"info",warning:"warn",critical:"crit",none:"none"})[a]??"ok",P=rt`
  :host {
    display:block;
...
`,Xi={ok:{bg:"rgba(123,232,168,.14)",color:h.ok,label:"Alles OK"},info:{bg:"rgba(154,200,255,.14)",color:h.info,label:"Info"},warning:{bg:"rgba(255,206,122,.14)",color:h.warn,label:"Warnung"},critical:{bg:"rgba(255,157,157,.16)",color:h.crit,label:"Kritisch"},none:{bg:"rgba(133,153,140,.14)",color:"#85998C",label:"Inaktiv"}};var oi="4d72-4461726b-766f6964",Pe=()=>oi,Le,xt=null;function vt(a){if(a?.states===Le&&xt)return xt;let e=new Map,t=new Set,i={};for(let[n,s]of Object.entries(a?.states??{})){let r=s?.attributes;if(!r?.growctrl_role||!r?.growctrl_tent)continue;let l=String(r.growctrl_tent),c=String(r.growctrl_station??"zelt");e.set(`${l}::${c}::${r.growctrl_role}`,n),c==="zelt"?t.add(l):(i[l]??=new Set).add(c)}return Le=a?.states,xt={tents:[...t].sort(),stations:Object.fromEntries(Object.entries(i).map(([n,s])=>[n,[...s].sort()])),byRole:e},xt}var O=(a,e,t,i)=>vt(a).byRole.get(`${e}::${t}::${i}`);var E=class extends B{constructor(){super(...arguments);this._config={};this._label=t=>t.label??t.name}static{this.properties={hass:{attribute:!1},_config:{state:!0}}}static{this.styles=rt`
  ...
  `}setConfig(t){this._config={...t}}_fire(t){this._config=t,this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:t},bubbles:!0,composed:!0}))}form(t){return o`<ha-form .hass=${this.hass} .data=${this._config} .schema=${t}
    ...
    ${a.map((w,A)=>{if(w.data.length<2)return u;let b=w.axis==="right"?v:y,F=w.data.map((ut,ht)=>[Number($(ht,w.data.length).toFixed(1)),Number(b(ut).toFixed(1))]),M=Be(F),R=F[F.length-1][0],nt=F[F.length-1][1];return X`
        ...
        ${w.fill!==!1?X`<path
          d="${M} L${R},${n-et} L${H},${n-et} Z"
          fill="url(#${t}-${A})"/>`:u}
        <path d="${M}" fill="none" stroke="${w.color}" stroke-width="2.4"
  ...
  </svg>`}function Dt(a,e,t=280,i=38){if(a.length<2)return o`<div style="height:${i}px"></div>`;let n=`gcs${Re++}`,s=Math.min(...a),r=Math.max(...a);r-s<.001&&(r+=1,s-=1);let l=x=>x/(a.length-1)*t,c=x=>3+(1-(x-s)/(r-s))*(i-8),p=a.map((x,$)=>[Number(l($).toFixed(1)),Number(c(x).toFixed(1))]),d=Be(p),m=p[p.length-1][0],f=p[p.length-1][1];return o`<svg data-gce="4d724461726b766f6964" viewBox="0 0 ${t} ${i}" style="width:100%;height:${i}px;display:block">
    ...
    <circle cx="${m}" cy="${f}" r="2.6" fill="${e}"/>
      ...
      <button class="gc dd-btn" aria-haspopup="listbox" aria-expanded=${this._phase} @click=${()=>{this._phase=!this._phase}}>
        <span class="pdot ${Ie[i]}" style="${i==="Auto"?"background:var(--acc);color:var(--acc)":""}"></span>${this.t(i)}
        <span class="hint">${this.t(Ne[i]??"")}</span>
      ...
      ${this._phase?o`<div class="dd-menu" role="listbox">
        ${ui.map(n=>o`<button class="gc dd-it" role="option" aria-selected=${n===i}
          @click=${()=>{this._select(t,n),this._phase=!1}}>
          <span class="pdot ${Ie[n]}" style="${n==="Auto"?"background:var(--acc)":""}"></span>${this.t(n)}<span class="hint">${this.t(Ne[n]??"")}</span></button>`)}
      </div>`:u}
    </div>`}render(){let t=this._config;if(!this.hass)return u;let i=this.hass.states[this.e("vpd")],n=!i&&!this.hass.states[this.e("enabled")],s=C(i?.state)??(n?1.06:null),r=i?.attributes?.temp,l=i?.attributes?.rh,c=i?.attributes?.phase_effektiv??"Veg",p=i?.attributes?.sollwerte,d=this.isOn(this.e("enabled"))||n,m=this.isOn(this.e("climate")),f=this.hass.states[this.e("status")],x=f?.attributes?.probleme??[],$=f?.state?.toLowerCase?.()==="problem"?"warning":d?"ok":"none",y=this.hass.states[this.e("event")],v=s!==null&&p&&s>=p.vpd_min&&s<=p.vpd_max,_=s!==null?Math.min(100,Math.max(0,s/Ut*100)):null,k=i?.attributes?.temp_entity||this.e("vpd"),T=i?.attributes?.rh_entity||this.e("vpd");return o`<div class="card ${t.style?.glass?"glass":""}" data-level=${$==="none"?"ok":$} style="${L(t.style)};position:relative">
      <div class="hd">
        ...
        <span class="pill ${d?D($):"none"}">${d?$==="ok"?this.t("Alles OK"):$==="warning"?this.t("Warnung"):this.t("Info"):this.t("Deaktiviert")}</span>
      </div>
      ...
      <div class="kpis">
        <button class="gc kpi c-temp" @click=${()=>this.moreInfo(k)}><span class="mlbl">${this.t("Temperatur")}</span><span class="v">${r!=null?Number(r).toFixed(1):"\u2013"}<span class="u">°C</span></span></button>
        <button class="gc kpi c-hum" @click=${()=>this.moreInfo(T)}><span class="mlbl">${this.t("Luftfeuchte")}</span><span class="v">${l!=null?Math.round(Number(l)):"\u2013"}<span class="u">%</span></span></button>
      ...
      <div style="margin-top:16px">
        <div class="zones">
          ${De.map(z=>o`<i style="width:${z.w}%;background:${z.col}"></i>`)}
        ...
        <div class="zlbl">${De.map(z=>o`<span style="width:${z.w}%">${this.t(z.lbl)}</span>`)}</div>
      </div>

      <div style="display:flex; gap:12px; flex-wrap:wrap; margin-top:14px; align-items:center">
        <span class="mlbl">${this.t("Modus")}</span>${this.chips(this.e("mode"),di,this.st(this.e("mode"))??"VPD")}
      </div>
      ...
      ${t.show_chart!==!1&&this._hist.length>1?o`
        ...
        ${V([{data:this._hist,color:v===!1?h.warn:h.ok,fill:!0}],{w:this.chartW(),h:96,band:p?{min:p.vpd_min,max:p.vpd_max}:void 0,grid:3})}`:u}

      ${x.length?o`<div style="display:flex; flex-wrap:wrap; gap:7px; margin-top:12px">
        ${x.map(z=>o`<span class="pbadge warn"><ha-icon icon="mdi:alert" style="--mdc-icon-size:12px"></ha-icon>${z}</span>`)}</div>`:u}

      ${y?o`<button class="gc event" style="margin-top:14px" @click=${()=>this.moreInfo(this.e("event"))}>
        <span class="edot" style="background:${y.attributes?.schweregrad==="critical"?h.crit:y.attributes?.schweregrad==="warning"?h.warn:h.info}"></span>
      ...
      </div>`}};customElements.define("growctrl-station-editor",Wt);var hi=["Aus","Seedling","Veg","Bloom","Flush","Trocknung"],He={Aus:"gestoppt",Seedling:"Anzucht",Veg:"Wachstum",Bloom:"Bl\xFCte",Flush:"Sp\xFClen",Trocknung:"Ernte"},gi={Aus:"pd-off",Seedling:"pd-seed",Veg:"pd-veg",Bloom:"pd-bloom",Flush:"pd-flush",Trocknung:"pd-dry"},mi={light:"mdi:lightbulb",heat:"mdi:radiator",water:"mdi:air-humidifier",pump:"mdi:water-pump",fan:"mdi:fan",o2:"mdi:scuba-tank"},Zt=class extends S{constructor(){super(...arguments);this._open=!1;this._phase=!1;this._plant=!1;this._spark={}}static{this.styles=P}static{this.properties={...S.properties,_open:{state:!0},_spark:{state:!0},_phase:{state:!0},_plant:{state:!0}}}updated(t){super.updated?.(t),!(!t.has("hass")&&!t.has("_config"))&&this.allSensors().forEach(async i=>{let n=await I(this.hass,i.entity,i.hours??24);n.length&&this._spark[i.entity]?.length!==n.length&&(this._spark={...this._spark,[i.entity]:n})})}trendArrow(t){if(!t||t.length<4)return null;let i=t.length,n=Math.max(2,Math.floor(i/4)),s=p=>p.reduce((d,m)=>d+m,0)/p.length,r=s(t.slice(-n))-s(t.slice(0,n)),l=Math.max(...t)-Math.min(...t)||1,c=r/l;return c>.06?{icon:"mdi:trending-up"}:c<-.06?{icon:"mdi:trending-down"}:{icon:"mdi:trending-neutral"}}validateConfig(t){if(!t.tent||!t.station)throw new Error("growctrl-station-card: 'tent' und 'station' sind Pflicht (wie in der Integration angelegt).")}static getConfigElement(){return document.createElement("growctrl-station-editor")}static getStubConfig(){return{tent:"gross",station:"main1"}}get isPreview(){return!this.hass?.states?.[this.e("stage")]}e(t){let[i,n,s]=$t[t];return this.eRole(i,n,s)}eRole(t,i,n){let s=this._config;return s.overrides?.[i]??O(this.hass,s.tent,s.station,n)??W(t,s.tent,s.station,i,s.overrides)}_select(t,i){this.hass.callService("select","select_option",{entity_id:t,option:i})}render(){let t=this._config;if(!this.hass)return u;let i=this.isPreview,n=this.st(this.e("stage"))??"Veg",s=Rt[n]??Rt.Veg,r=this.isOn(this.e("auto"))||i,l=this.isOn(this.e("wartung")),c=O(this.hass,t.tent,"zelt","tent_enabled")??Z("switch",t.tent,"tent_enabled",t.overrides),p=!!this.hass.states[c]&&!this.isOn(c),d=n==="Aus",m=p||d,f=!r||l||p||d,x=[{e:this.e("pOverride"),label:"Manueller Eingriff",crit:!1},{e:this.e("pFailsafe"),label:"Licht-Failsafe",crit:!0},{e:this.e("pTime"),label:"Zeiten unvollst\xE4ndig",crit:!1},{e:this.e("pPump"),label:"Pumpe gesperrt (F\xFCllstand)",crit:!1},{e:this.e("pPower"),label:"Licht ohne Leistung",crit:!0}].filter(_=>this.isOn(_.e)),$=this.hass.states[this.e("event")],y=m?"warning":x.length?x.some(_=>_.crit)?"critical":"warning":$?.attributes?.schweregrad==="critical"?"warning":"ok",v=l?this.t("Wartung aktiv"):p?this.t("Zelt aus \u2013 gestoppt"):d?this.t("Station aus"):y==="critical"?this.t("Kritisch"):y==="warning"?this.t("Warnung"):this.t("Alles OK");return o`<div class="card ${t.style?.glass?"glass":""}" data-level=${y} style="${L(t.style)};position:relative">
        ...
        <div class="grow" style="min-width:0">
          ...
          <div class="sub" style="display:flex;align-items:center;gap:7px">
            <span style="width:7px;height:7px;border-radius:50%;flex-shrink:0;
              background:${y==="critical"?h.crit:y==="warning"?h.warn:h.ok};
              box-shadow:0 0 8px currentColor;color:${y==="critical"?h.crit:y==="warning"?h.warn:h.ok}"></span>
            ${v}
          </div>
        </div>
    ...
    </div>`}phaseDropdown(t,i){let n=C(this.st(this.e("age"))),s=n!==null?`${this.t("Tag")} ${n}`:this.t(He[t]??"");return o`<div class="dd ${this._phase?"open":""}">
      ...
      ${this._phase?o`<div class="dd-menu" role="listbox">
        ${hi.map(r=>o`<button class="gc dd-it" role="option" aria-selected=${r===t}
          @click=${()=>{this._select(this.e("stage"),r),this._phase=!1}}>
          <span class="pdot ${gi[r]}"></span>${this.t(r)}<span class="hint">${this.t(He[r]??"")}</span></button>`)}
      </div>`:u}
      ...
      <div class="gc supply" style="margin-top:8px">
        ...
        ${y!==null?o`<span class="bar"><i style="width:${Math.min(100,Math.max(0,y))}%;
      ...
      </span>`}sensorInd(t){let i=C(this.st(t.entity)),n=t.name??this.friendly(t.entity),s=this.unit(t.entity),r=t.anzeige??"wert",l=t.entity.split(".")[0],c=l==="number"||l==="input_number",p=this.hass.states[t.entity]?.attributes??{},d=t.step??(Number(p.step)||.1),m=p.min,f=p.max,x=(String(d).split(".")[1]??"").length||1,$=A=>{let b=A;m!==void 0&&(b=Math.max(m,b)),f!==void 0&&(b=Math.min(f,b)),this.hass.callService(l,"set_value",{entity_id:t.entity,value:Number(b.toFixed(x))})},y,v=t.ideal??[0,0],_=t.ok??v;if(r==="zone"){let A=i!==null&&i>=v[0]&&i<=v[1],b=i!==null&&i>=_[0]&&i<=_[1];y=t.color??(A?h.ok:b?h.warn:h.crit)}else r==="graph"?y=t.color??h.water:y=t.color??"rgba(242,247,243,.95)";let k=this.trendArrow(this._spark[t.entity]),T=k?o`<ha-icon icon="${k.icon}" title=${this.t("Trend")}
          style="--mdc-icon-size:13px;color:var(--tx-3);margin-right:3px;vertical-align:-2px"></ha-icon>`:u,z=o`<div class="ihd">
      <span class="ilbl" style="color:${r==="wert"?"var(--tx-2)":y}">
      ...
      ${c?o`<span class="setrow">
            <button class="gc stepbtn" title=${this.t("weniger")} @click=${A=>{A.stopPropagation(),i!==null&&$(i-d)}}><ha-icon icon="mdi:minus" style="--mdc-icon-size:16px"></ha-icon></button>
            <span class="setval" style="color:${y}">${T}${i!==null?i:"\u2013"}<span class="u">${s}</span></span>
            <button class="gc stepbtn" title=${this.t("mehr")} @click=${A=>{A.stopPropagation(),$((i??m??0)+d)}}><ha-icon icon="mdi:plus" style="--mdc-icon-size:16px"></ha-icon></button></span>`:o`<span class="ival" style="color:${y}">
            ${T}${i!==null?i:this.st(t.entity)??"\u2013"}<span class="u">${s}</span></span>`}
    </div>`,w=r==="zone"?o`${this.zoneV6(i,t.min??0,t.max??14,_,v)}
          ${(this._spark[t.entity]?.length??0)>1?o`<div class="spark" style="margin-top:7px;opacity:.85">${Dt(this._spark[t.entity],y,this.chartW(74),28)}</div>`:u}`:r==="graph"?o`<div class="spark">${Dt(this._spark[t.entity]??[],y,this.chartW(74),38)}</div>`:u;return o`<div class="ind" style="cursor:pointer" @click=${()=>this.moreInfo(t.entity)}>${z}${w}</div>`}mediaBlock(){let t=this._config,i=t.media_height??180;if(t.image_url)return o`<div class="seclbl">${this.t("Livestream")}</div>
        ...
        </button>`}return u}logExcerpt(){if(this._config.show_log===!1)return u;let n=this.hass.states[this.e("event")]?.attributes?.verlauf??[];if(!n.length)return u;let s=n.slice(-3).reverse();return o`<div class="seclbl">${this.t("Protokoll")}</div>
      ...
      ${[...i.entries()].map(([n,s])=>o`
        ...
        <div class="acts" style="grid-template-columns:repeat(${t},1fr); ${n?"":"margin-top:4px"}">
          ${s.map(r=>{let l=this.isOn(r.entity),c=r.name??this.friendly(r.entity),p=r.kind??"",d=p==="light"||p==="heat"||p==="water"?p:"",m=r.icon??this.hass.states[r.entity]?.attributes?.icon??vi[p]??xi[r.entity.split(".")[0]]??"mdi:power";return o`<button class="gc act ${l?"on":""} ${l?d:""}" style="position:relative"
      ...
      ${this.renderConfirm()}
    </div>`}};customElements.define("growctrl-controls-card",Kt);var yi=[g.text("title","\u{1F3F7}\uFE0F Titel"),g.num("columns","\u25A6 Spalten",1,6)],$i=[g.entity("entity","\u{1F4C8} Sensor","sensor"),g.text("name","\u270F\uFE0F Anzeigename (optional)"),g.num("min","Sollbereich Min (optional)"),g.num("max","Sollbereich Max (optional)"),g.select("accent","\u{1F3A8} Akzentfarbe (optional)",[{value:"temp",label:"Temperatur (orange)"},{value:"hum",label:"Feuchte (blau)"},{value:"vpd",label:"VPD (Akzent)"}])],jt=class extends E{render(){return o`${this.form(yi)}
      ${this.list({key:"sensors",rowSchema:$i,title:"\u{1F4C8} Sensoren",addLabel:"Sensor hinzuf\xFCgen",newItem:()=>({entity:""})})}
      ${this.styleSection()}
    ...
    </div>`}};customElements.define("growctrl-status-card",Yt);var ki=[g.text("title","\u{1F3F7}\uFE0F Titel (optional)"),g.text("logo","\u{1F5BC}\uFE0F Logo-URL (z.B. /local/growctrl/logo.png)"),g.bool("show_chart","\u{1F4C8} 24h-Chart zus\xE4tzlich zum Zonen-Balken"),g.num("hours","\u23F1\uFE0F Chart-Zeitraum (h)",1,168)],Qt=class extends E{render(){let e=[this.stationSelect(this._config?.tent),g.text("name","\u270F\uFE0F Anzeigename (optional)")];return o`${this.form([this.tentSelect("tent","\u{1F3D5}\uFE0F Zelt"),...ki])}
      ...
      <div class="hint">Die Hero-Karte ist die Zelt-\u00dcbersicht: Klima-Werte, VPD-Skala und das
        Informationssystem. Die gelisteten <b>Stationen</b> liefern die Ereigniszeilen darunter.</div>`}};customElements.define("growctrl-hero-editor",Qt);var Ue=[{w:20,col:"#6E97DE",lbl:"zu feucht"},{w:20,col:"#58E0A5",lbl:"Seedling"},{w:20,col:"#2FB36C",lbl:"Veg"},{w:20,col:"#E5B567",lbl:"Bloom"},{w:20,col:"#D4726F",lbl:"zu trocken"}],Jt=2,te=class extends S{constructor(){super(...arguments);this._logoErr=!1;this._hist=[]}static{this.styles=P}static{this.properties={...S.properties,_hist:{state:!0},_logoErr:{state:!0}}}validateConfig(t){if(!t.tent)throw new Error("growctrl-hero-card: 'tent' ist Pflicht (Zelt-Name aus der Integration).")}static getConfigElement(){return document.createElement("growctrl-hero-editor")}static getStubConfig(){return{tent:"gross",stations:[{station:"main1"}]}}te(t){let[i,n,s]=it[t],r=this._config;return r.overrides?.[n]??O(this.hass,r.tent,"zelt",s)??Z(i,r.tent,n,r.overrides)}connectedCallback(){super.connectedCallback(),this._load(),this._timer=window.setInterval(()=>this._load(),5*6e4)}disconnectedCallback(){super.disconnectedCallback(),this._timer&&clearInterval(this._timer)}async _load(){if(!this.hass){setTimeout(()=>this._load(),1e3);return}this._hist=await I(this.hass,this.te("vpd"),this._config.hours??24)}tglBtn(t,i,n){return o`<button class="gc tgl ${n?"on":""}" @click=${()=>this.confirmToggle(t,i)}>
      <span class="sw"></span> ${i}</button>`}render(){let t=this._config;if(!this.hass)return u;let i=this.hass.states[this.te("vpd")],n=!i&&!this.hass.states[this.te("enabled")],s=C(i?.state)??(n?.76:null),r=i?.attributes?.temp??(n?21.5:null),l=i?.attributes?.rh??(n?61:null),c=i?.attributes?.phase_effektiv??"",p=i?.attributes?.sollwerte,d=this.isOn(this.te("enabled"))||n,m=this.isOn(this.te("climate")),f=this.hass.states[this.te("status")],x=f?.attributes?.probleme??[],$=(t.stations??[]).map(b=>{let F=this.hass.states[O(this.hass,t.tent,b.station,"last_event")??W("sensor",t.tent,b.station,"letztes_ereignis",t.overrides)],M=this.hass.states[O(this.hass,t.tent,b.station,"light_rest")??W("sensor",t.tent,b.station,"licht_restzeit",t.overrides)],R=F?.attributes?.schweregrad??"ok";return{name:b.name??b.station,text:F?.state??"\u2013",level:R,lightText:M?.attributes?.text??(M?.state?`${this.t("Licht")} ${this.t(String(M.attributes?.zustand??""))}`:""),on:M?.attributes?.zustand==="an",ent:O(this.hass,t.tent,b.station,"last_event")??W("sensor",t.tent,b.station,"letztes_ereignis",t.overrides)}}),y=b=>b==="warning"||b==="critical",v=tt([(f?.state??"").toLowerCase()==="problem"?"warning":"ok",...$.map(b=>y(b.level)?b.level:"ok")]),_=[...x.map(b=>({label:b,level:"warning"})),...$.filter(b=>y(b.level)).map(b=>({label:`${b.name}: ${b.text}`,level:b.level}))],k=s!==null&&p&&s>=p.vpd_min&&s<=p.vpd_max,T=s!==null?Math.min(100,Math.max(0,s/Jt*100)):null,z=this.isOn(this.te("stale")),w=i?.attributes?.temp_entity||this.te("vpd"),A=i?.attributes?.rh_entity||this.te("vpd");return o`<div class="card ${t.style?.glass?"glass":""}" data-level=${v} style="${L(t.style)};position:relative">
      <div class="hd">
      ...
      <div class="kpis">
        ...
        <button class="gc kpi c-hum" @click=${()=>this.moreInfo(A)}>
        ...
        <button class="gc kpi c-vpd" @click=${()=>this.moreInfo(this.te("vpd"))}>
          <span class="mlbl">VPD</span><span class="v" style="${s!==null&&!k?`color:${h.warn}`:""}">${s!==null?s.toFixed(2):"\u2013"}<span class="u">kPa</span></span></button>
      </div>

      ${z?o`<div style="margin-top:10px;display:flex;align-items:center;gap:7px;padding:7px 12px;border-radius:10px;
      ...
      <div style="margin-top:16px">
        <div class="zones">
          ...
          ${p?o`<span class="zband" style="left:${p.vpd_min/Jt*100}%;width:${(p.vpd_max-p.vpd_min)/Jt*100}%"></span>`:u}
          ${T!==null?o`<span class="zmark" style="left:${T}%"></span>`:u}
        </div>
      ...
      ${t.show_chart===!0&&this._hist.length>1?o`
        <div class="seclbl">VPD · ${t.hours??24}h</div>
        ${V([{data:this._hist,color:k===!1?h.warn:h.ok,fill:!0}],{w:this.chartW(),h:96,band:p?{min:p.vpd_min,max:p.vpd_max}:void 0,grid:3})}`:u}

      ${$.length?o`<div class="seclbl">${this.t("Stationen")}</div>
        <div style="display:flex; flex-direction:column; gap:7px">
          ${$.map(b=>o`<button class="gc supply" @click=${()=>b.ent&&this.moreInfo(b.ent)}>
            <span class="shd">
              ...
              <span class="sbadge" style="color:${y(b.level)?b.level==="critical"?h.crit:h.warn:h.ok}">${y(b.level)?b.level==="critical"?this.t("Fehler"):this.t("Warnung"):this.t("OK")}</span>
            </span>
      ...
      ${this.renderConfirm()}
    </div>`}};customElements.define("growctrl-hero-card",te);var ee=class extends E{render(){let e=this._config.tent,t=[this.tentSelect("tent","\u{1F3D5}\uFE0F Zelt"),g.text("title","\u{1F3F7}\uFE0F Titel"),g.bool("show_sensors","\u{1F9EA} Sensoren-Sektion zeigen (pH/EC/Temp/RH/\u2026, Standard an)"),g.bool("show_controls","\u{1F39B}\uFE0F Steuerungs-Sektion zeigen (Licht/Pumpe/\u2026, Standard an)"),g.bool("show_tent_row","\u{1F3D5}\uFE0F Zelt-Sektion zeigen (Aktiv/Klima/VPD/Status)"),g.text("tent_name","\u270F\uFE0F Name der Zelt-Zeile (optional)")],i=[this.stationSelect(e,"station","\u{1F331} Station (= Pflanze)"),g.text("name","\u270F\uFE0F Anzeigename (optional)")];return o`${this.form(t)}
      ...
      <div class="hint">Drei Ampel-Sektionen: <b>Sensoren</b> (pH / EC / Temperatur / Feuchte /
        ...
        <b>grau</b> = kein Wert, <b>leere Zelle</b> = dieser Sensor ist an der Station nicht angelegt. Tippen \u00f6ffnet die Entit\u00e4t.</div>`}};customElements.define("growctrl-checkup-editor",ee);var Si=[{key:"ph",icon:"mdi:ph",label:"pH",range:"ph",margin:.3},{key:"ec",icon:"mdi:flash-outline",label:"EC",range:"ec",margin:.3},{key:"temp",icon:"mdi:thermometer",label:"Temp",range:null,margin:0},{key:"humidity",icon:"mdi:water-percent",label:"RH",range:null,margin:0},{key:"water_temp",icon:"mdi:coolant-temperature",label:"Wasser",range:null,margin:0},{key:"soil_temp",icon:"mdi:thermometer-low",label:"Boden",range:null,margin:0}],ie=class extends S{static{this.styles=P}validateConfig(e){if(!Array.isArray(e.stations)||!e.stations.length)throw new Error("growctrl-checkup-card: 'stations' (min. 1) ist Pflicht.")}static getConfigElement(){return document.createElement("growctrl-checkup-editor")}static getStubConfig(){return{tent:"gross",show_tent_row:!0,stations:[{station:"main1"},{station:"main2"}]}}sEnt(e,t,i){let[n,s,r]=$t[i];return O(this.hass,e,t,r)??W(n,e,t,s)}tEnt(e,t){let[i,n,s]=it[t];return O(this.hass,e,"zelt",s)??Z(i,e,n)}sensorColsPresent(e){return Si.filter(t=>e.some(i=>!!(this.hass.states[this.sEnt(i.tent,i.station,"event")]?.attributes?.gc_sensors??{})[t.key]))}sensorCell(e,t,i){let s=this.hass.states[this.sEnt(e,t,"event")]?.attributes??{},l=(s.gc_sensors??{})[i.key];if(!l)return{configured:!1,level:"off",title:""};let c=C(this.hass.states[l]?.state);if(c===null)return{configured:!0,level:"off",title:this.t("kein Wert")};let p=null;if(i.range==="ph"?p=s.gc_ph_bereich??null:i.range==="ec"&&(p=s.gc_ec_bereich??null),!p)return{configured:!0,level:"ok",title:`${c}`};let[d,m]=p,f=c>=d&&c<=m,x=c>=d-i.margin&&c<=m+i.margin;return{configured:!0,level:f?"ok":x?"warning":"critical",title:`${i.label} ${c} (${this.t("ideal")} ${d}\u2013${m})`}}avail(e){let t=this.hass.states[e];return!!t&&t.state!=="unavailable"&&t.state!=="unknown"}stationCells(e,t){let i=this.sEnt(e,t,"lightRest"),n=this.sEnt(e,t,"pumpRest"),s=this.sEnt(e,t,"heatActive"),r=this.sEnt(e,t,"auto"),l=this.sEnt(e,t,"pOverride"),c=this.sEnt(e,t,"event"),p=this.tEnt(e,"enabled"),d=this.avail(p)&&!this.isOn(p),m=this.hass.states[this.sEnt(e,t,"stage")]?.state==="Aus",f=d||m,x=this.hass.states[i],$=x?.attributes?.zustand==="an",y=this.isOn(this.sEnt(e,t,"pFailsafe")),v=this.isOn(this.sEnt(e,t,"pPower"))||this.isOn(this.sEnt(e,t,"pTime")),_={present:this.avail(i),ent:i,level:y?"critical":v?"warning":$?"ok":"off",text:y?this.t("Licht-Failsafe ausgel\xF6st"):this.isOn(this.sEnt(e,t,"pPower"))?this.t("Licht AN ohne Leistung"):this.isOn(this.sEnt(e,t,"pTime"))?this.t("Lichtzeiten unvollst\xE4ndig"):$?this.t("Licht an"):x?.attributes?.aktiv===!1?this.t("Licht ausgeschaltet"):this.t("Licht aus")},k=this.isOn(this.sEnt(e,t,"pPump")),T=this.hass.states[n],z={present:this.avail(n),ent:n,level:k?"critical":T?.attributes?.aktiv===!1?"off":"ok",text:k?this.t("Pumpe gesperrt (F\xFCllstand)"):T?.attributes?.aktiv===!1?this.t("Pumpe ausgeschaltet"):T?.attributes?.text??this.t("Zyklus l\xE4uft")},w=this.isOn(this.sEnt(e,t,"heatSensorFault")),A=this.isOn(this.sEnt(e,t,"heatOvertemp")),b=this.isOn(this.sEnt(e,t,"heatEnabled")),F=this.hass.states[s],M=F?.state==="on",R=F?.attributes??{},nt={present:this.avail(s),ent:s,level:w||A?"critical":b?"ok":"off",text:w?this.t("Heizung Sensorfehler"):A?this.t("Heizung \xDCbertemperatur"):b?M?`${this.t("Heizung heizt")}${typeof R.ist_temp=="number"?` \xB7 ${R.ist_temp} \xB0C`:""}`:this.t("Heizung bereit"):this.t("Heizung aus")},ut=this.isOn(r),ht=this.isOn(this.sEnt(e,t,"wartung")),We={present:this.avail(r),ent:r,level:ht?"info":ut?"ok":"warning",text:ht?this.t("Wartungsmodus aktiv"):ut?this.t("Automatik AN"):this.t("Automatik AUS (manuell)")},ce=this.isOn(l),Ze={present:this.avail(l),ent:l,level:ce?"warning":"ok",text:ce?this.t("Manueller Eingriff aktiv"):this.t("Kein Eingriff")},pe=this.hass.states[c],de=pe?.attributes?.schweregrad??"ok",Ge={present:!0,ent:c,level:f?"warning":de==="critical"?"critical":de==="warning"?"warning":"ok",text:d?this.t("Zelt aus \u2013 Station gestoppt"):m?this.t("Station aus"):pe?.state??"OK"};return{licht:_,pumpe:z,heizung:nt,auto:We,eingriff:Ze,status:Ge}}tentCells(e){let t=this.isOn(this.tEnt(e,"enabled")),i=t?"ok":"warning",n=t?this.t("Zelt aktiv"):this.t("Zelt deaktiviert"),s=this.isOn(this.tEnt(e,"climate")),r=s?"ok":"off",l=s?this.t("Klima-Automatik AN"):this.t("Klima-Automatik AUS"),c=this.hass.states[this.tEnt(e,"vpd")],p=C(c?.state),d=c?.attributes?.sollwerte,m=p!==null&&d?p>=d.vpd_min&&p<=d.vpd_max?"ok":"warning":c?"ok":"off",f=p!==null?`VPD ${p.toFixed(2)} kPa${d?` (${this.t("Soll")} ${d.vpd_min}\u2013${d.vpd_max})`:""}`:"\u2014",x=this.hass.states[this.tEnt(e,"status")],$=(x?.state??"").toLowerCase()==="problem",y=x?.attributes?.probleme??[],v=$?"warning":"ok",_=$?y[0]??this.t("Problem erkannt"):this.t("Alles OK");return{aktiv:i,klima:r,vpd:m,status:v,aktivText:n,klimaText:l,vpdText:f,statusText:_,ent:{aktiv:this.tEnt(e,"enabled"),klima:this.tEnt(e,"climate"),vpd:this.tEnt(e,"vpd"),status:this.tEnt(e,"status")}}}dot(e){return o`<span class="dot ${e==="off"?"off":D(e)}"></span>`}mc(e,t,i){return o`<button class="gc mc" title=${t} @click=${()=>i&&this.moreInfo(i)}>${this.dot(e)}</button>`}pCell(e,t){return e.configured?e.level==="off"?o`<span class="mc" style="cursor:default">${this.dot("off")}</span>`:this.mc(e.level,e.title,t):o`<span class="mc" style="cursor:default"></span>`}cCell(e){return e.present?this.mc(e.level,e.text,e.ent):o`<span class="mc" style="cursor:default"></span>`}mh(e,t){return o`<span class="mh" title=${this.t(t)}><ha-icon icon=${e}></ha-icon></span>`}mClass(e){return e===4?"m4":e===5?"m5":e===6?"m6":""}gridStyle(e){return this.mClass(e)?"":`grid-template-columns:1fr repeat(${e}, minmax(0,46px))`}render(){let e=this._config;if(!this.hass)return u;let t=(e.stations??[]).map(v=>({tent:v.tent??e.tent??"gross",station:v.station,name:v.name??v.station})),i=e.tent??t[0]?.tent??"gross",n=e.show_tent_row!==!1,s=e.show_sensors!==!1,r=e.show_controls!==!1,l=[],c=s?this.sensorColsPresent(t):[],p=c.length?t.map(v=>{let _=c.map(k=>({col:k,cell:this.sensorCell(v.tent,v.station,k)}));return _.forEach(k=>{k.cell.configured&&k.cell.level!=="off"&&l.push(k.cell.level)}),{...v,cells:_}}):[],d=t.some(v=>!!this.hass.states[this.sEnt(v.tent,v.station,"heatActive")]),m=r?t.map(v=>{let _=this.stationCells(v.tent,v.station);return[_.status,_.pumpe,_.licht,_.auto,_.eingriff,...d?[_.heizung]:[]].forEach(k=>{k.present&&l.push(k.level)}),{...v,cells:_}}):[],f=n?this.tentCells(i):null;f&&l.push(f.status,f.aktiv,f.vpd);let x=tt(l),$=c.length,y=d?6:5;return o`<div class="card ${e.style?.glass?"glass":""}" data-level=${x} style=${L(e.style)}>
      <div class="hd">
        <div class="grow">
      ...
      ${$?o`
        ...
        <div class="matrix ${this.mClass($)}" style=${this.gridStyle($)}>
          ...
          ${p.map(v=>o`
            ...
            ${v.cells.map(({col:_,cell:k})=>this.pCell(k,this.hass.states[this.sEnt(v.tent,v.station,"event")]?.attributes?.gc_sensors?.[_.key]??void 0))}`)}
        </div>`:u}

      ${m.length?o`
        <div class="seclbl">${this.t("Steuerung")}</div>
        <div class="matrix ${d?"m6":"m5"}" style=${this.gridStyle(y)}>
          <span></span>
    ...
    </div>`}};customElements.define("growctrl-checkup-card",ie);var Ai=[g.text("title","\u{1F3F7}\uFE0F Titel"),g.entity("entity","\u{1F4A7} F\xFCllstand-Sensor (%) (Pflicht)","sensor"),g.num("min","\u26A0\uFE0F Mindeststand (%)",0,100),g.num("volume_l","\u{1FAA3} Tankvolumen (Liter, optional)",0,2e3)],ne=class extends E{render(){return o`${this.form(Ai)}${this.styleSection()}
      <div class="hint">Der <b>F\u00fcllstand-Sensor</b> liefert Prozent. Unter dem <b>Mindeststand</b> wird der
        Tank rot. Mit <b>Tankvolumen</b> zeigt die Karte zus\u00e4tzlich die ungef\u00e4hren Liter an.</div>`}};customElements.define("growctrl-tank-editor",ne);var se=class extends S{static{this.styles=P}validateConfig(e){if(!e.entity)throw new Error("growctrl-tank-card: 'entity' (Fuellstand-Sensor in %) ist Pflicht.")}static getConfigElement(){return document.createElement("growctrl-tank-editor")}static getStubConfig(){return{entity:"sensor.gc_slot1_level1",title:"Tank",min:30,volume_l:200}}render(){let e=this._config;if(!this.hass)return u;let t=!this.hass.states[e.entity],i=Math.min(100,Math.max(0,C(this.st(e.entity))??(t?49:0))),n=e.min!==void 0&&i<e.min,s=n?h.crit:h.water,r=e.volume_l?i/100*e.volume_l:null;return o`<div class="card ${e.style?.glass?"glass":""}" data-level=${n?"critical":"ok"} style=${L(e.style)}>
      <div class="hd">
    ...
    </div>`}};customElements.define("growctrl-tank-card",se);var Ei=[g.text("title","\u{1F3F7}\uFE0F Titel"),g.num("hours","\u23F1\uFE0F Zeitraum (h)",1,168),g.num("height","\u{1F4CF} Diagrammh\xF6he (px)",80,300)],Ci=[g.entity("entity","\u{1F4C8} Sensor","sensor"),g.text("name","\u270F\uFE0F Anzeigename (optional)"),g.select("axis","\u{1F4CA} Achse",[{value:"left",label:"Links (Standard)"},{value:"right",label:"Rechts (zweite Achse)"}]),g.text("color","\u{1F3A8} Farbe (optional, z.B. #FF9F5A)")],re=class extends E{render(){return o`${this.form(Ei)}
      ${this.list({key:"sensors",rowSchema:Ci,title:"\u{1F4C9} Serien",addLabel:"Sensor hinzuf\xFCgen",newItem:()=>({entity:""})})}
      ${this.styleSection()}
      ...
      ${V(r,{w:this.chartW(),h:t.height??120,grid:3,hours:t.hours??24})}
      <div class="legend">
      ...
      <div style="margin-top:6px">
        ${V([{data:this._hist,color:r?h.crit:h.ok,fill:!0}],{w:this.chartW(),h:t.height??104,band:{min:t.min,max:t.max},grid:3})}
      </div>
    </div>`}};customElements.define("growctrl-metric-card",le);var Fi="4.0.0",Li=[{type:"growctrl-tent-card",name:"GROWCTRL Tent",description:"Zelt-Hero: Klima-KPIs, VPD-Skala, Status-Ampel"},{type:"growctrl-station-card",name:"GROWCTRL Station",description:"Station: Licht-/Pumpenbalken, Stage, Auto, Konfiguration"},{type:"growctrl-controls-card",name:"GROWCTRL Controls",description:"Aktoren-Raster mit Gruppen und Bestaetigung"},{type:"growctrl-sensors-card",name:"GROWCTRL Sensors",description:"Sensor-KPIs mit Sollbereich-Ampel"},{type:"growctrl-status-card",name:"GROWCTRL Status",description:"Ereignisprotokoll der Integration mit Schweregrad-Ampel"},{type:"growctrl-hero-card",name:"GROWCTRL Hero",description:"Globale Steuerung, Klima-KPIs, VPD-Chart, Informationssystem"},{type:"growctrl-checkup-card",name:"GROWCTRL Checkup",description:"Checkup-Matrix: Licht/Pumpe/Klima/Status je Station"},{type:"growctrl-tank-card",name:"GROWCTRL Tank",description:"DWC-Fuellstand (vertikaler Tank) mit Warnstufe"},{type:"growctrl-history-card",name:"GROWCTRL History",description:"24h-Diagramm (z.B. Temperatur + Luftfeuchte)"},{type:"growctrl-metric-card",name:"GROWCTRL Metric",description:"EC/pH gross mit Chart und Sollbereich"}];window.customCards=window.customCards??[];window.__gcEpoch=Pe();Li.forEach(a=>window.customCards.push({...a,preview:!0,documentationURL:"https://github.com/MrDarkvoid/growctrl"}));console.info(`%c GROWCTRL Cards %c v${Fi} `,"background:#1D9E75;color:#fff;font-weight:700","background:#0F6E56;color:#fff");
