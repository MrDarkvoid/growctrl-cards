var gt=globalThis,mt=gt.ShadowRoot&&(gt.ShadyCSS===void 0||gt.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,_t=Symbol(),me=new WeakMap,st=class{constructor(e,t,i){if(this._$cssResult$=!0,i!==_t)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=e,this.t=t}get styleSheet(){let e=this.o,t=this.t;if(mt&&e===void 0){let i=t!==void 0&&t.length===1;i&&(e=me.get(t)),e===void 0&&((this.o=e=new CSSStyleSheet).replaceSync(this.cssText),i&&me.set(t,e))}return e}toString(){return this.cssText}},fe=a=>new st(typeof a=="string"?a:a+"",void 0,_t),rt=(a,...e)=>{let t=a.length===1?a[0]:e.reduce((i,n,s)=>i+(r=>{if(r._$cssResult$===!0)return r.cssText;if(typeof r=="number")return r;throw Error("Value passed to 'css' function must be a 'css' function result: "+r+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(n)+a[s+1],a[0]);return new st(t,a,_t)},be=(a,e)=>{if(mt)a.adoptedStyleSheets=e.map(t=>t instanceof CSSStyleSheet?t:t.styleSheet);else for(let t of e){let i=document.createElement("style"),n=gt.litNonce;n!==void 0&&i.setAttribute("nonce",n),i.textContent=t.cssText,a.appendChild(i)}},kt=mt?a=>a:a=>a instanceof CSSStyleSheet?(e=>{let t="";for(let i of e.cssRules)t+=i.cssText;return fe(t)})(a):a;var{is:Je,defineProperty:ti,getOwnPropertyDescriptor:ei,getOwnPropertyNames:ii,getOwnPropertySymbols:ni,getPrototypeOf:si}=Object,ft=globalThis,xe=ft.trustedTypes,ri=xe?xe.emptyScript:"",ai=ft.reactiveElementPolyfillSupport,at=(a,e)=>a,St={toAttribute(a,e){switch(e){case Boolean:a=a?ri:null;break;case Object:case Array:a=a==null?a:JSON.stringify(a)}return a},fromAttribute(a,e){let t=a;switch(e){case Boolean:t=a!==null;break;case Number:t=a===null?null:Number(a);break;case Object:case Array:try{t=JSON.parse(a)}catch{t=null}}return t}},ye=(a,e)=>!Je(a,e),ve={attribute:!0,type:String,converter:St,reflect:!1,useDefault:!1,hasChanged:ye};Symbol.metadata??=Symbol("metadata"),ft.litPropertyMetadata??=new WeakMap;var N=class extends HTMLElement{static addInitializer(e){this._$Ei(),(this.l??=[]).push(e)}static get observedAttributes(){return this.finalize(),this._$Eh&&[...this._$Eh.keys()]}static createProperty(e,t=ve){if(t.state&&(t.attribute=!1),this._$Ei(),this.prototype.hasOwnProperty(e)&&((t=Object.create(t)).wrapped=!0),this.elementProperties.set(e,t),!t.noAccessor){let i=Symbol(),n=this.getPropertyDescriptor(e,i,t);n!==void 0&&ti(this.prototype,e,n)}}static getPropertyDescriptor(e,t,i){let{get:n,set:s}=ei(this.prototype,e)??{get(){return this[t]},set(r){this[t]=r}};return{get:n,set(r){let l=n?.call(this);s?.call(this,r),this.requestUpdate(e,l,i)},configurable:!0,enumerable:!0}}static getPropertyOptions(e){return this.elementProperties.get(e)??ve}static _$Ei(){if(this.hasOwnProperty(at("elementProperties")))return;let e=si(this);e.finalize(),e.l!==void 0&&(this.l=[...e.l]),this.elementProperties=new Map(e.elementProperties)}static finalize(){if(this.hasOwnProperty(at("finalized")))return;if(this.finalized=!0,this._$Ei(),this.hasOwnProperty(at("properties"))){let t=this.properties,i=[...ii(t),...ni(t)];for(let n of i)this.createProperty(n,t[n])}let e=this[Symbol.metadata];if(e!==null){let t=litPropertyMetadata.get(e);if(t!==void 0)for(let[i,n]of t)this.elementProperties.set(i,n)}this._$Eh=new Map;for(let[t,i]of this.elementProperties){let n=this._$Eu(t,i);n!==void 0&&this._$Eh.set(n,t)}this.elementStyles=this.finalizeStyles(this.styles)}static finalizeStyles(e){let t=[];if(Array.isArray(e)){let i=new Set(e.flat(1/0).reverse());for(let n of i)t.unshift(kt(n))}else e!==void 0&&t.push(kt(e));return t}static _$Eu(e,t){let i=t.attribute;return i===!1?void 0:typeof i=="string"?i:typeof e=="string"?e.toLowerCase():void 0}constructor(){super(),this._$Ep=void 0,this.isUpdatePending=!1,this.hasUpdated=!1,this._$Em=null,this._$Ev()}_$Ev(){this._$ES=new Promise(e=>this.enableUpdating=e),this._$AL=new Map,this._$E_(),this.requestUpdate(),this.constructor.l?.forEach(e=>e(this))}addController(e){(this._$EO??=new Set).add(e),this.renderRoot!==void 0&&this.isConnected&&e.hostConnected?.()}removeController(e){this._$EO?.delete(e)}_$E_(){let e=new Map,t=this.constructor.elementProperties;for(let i of t.keys())this.hasOwnProperty(i)&&(e.set(i,this[i]),delete this[i]);e.size>0&&(this._$Ep=e)}createRenderRoot(){let e=this.shadowRoot??this.attachShadow(this.constructor.shadowRootOptions);return be(e,this.constructor.elementStyles),e}connectedCallback(){this.renderRoot??=this.createRenderRoot(),this.enableUpdating(!0),this._$EO?.forEach(e=>e.hostConnected?.())}enableUpdating(e){}disconnectedCallback(){this._$EO?.forEach(e=>e.hostDisconnected?.())}attributeChangedCallback(e,t,i){this._$AK(e,i)}_$ET(e,t){let i=this.constructor.elementProperties.get(e),n=this.constructor._$Eu(e,i);if(n!==void 0&&i.reflect===!0){let s=(i.converter?.toAttribute!==void 0?i.converter:St).toAttribute(t,i.type);this._$Em=e,s==null?this.removeAttribute(n):this.setAttribute(n,s),this._$Em=null}}_$AK(e,t){let i=this.constructor,n=i._$Eh.get(e);if(n!==void 0&&this._$Em!==n){let s=i.getPropertyOptions(n),r=typeof s.converter=="function"?{fromAttribute:s.converter}:s.converter?.fromAttribute!==void 0?s.converter:St;this._$Em=n;let l=r.fromAttribute(t,s.type);this[n]=l??this._$Ej?.get(n)??l,this._$Em=null}}requestUpdate(e,t,i,n=!1,s){if(e!==void 0){let r=this.constructor;if(n===!1&&(s=this[e]),i??=r.getPropertyOptions(e),!((i.hasChanged??ye)(s,t)||i.useDefault&&i.reflect&&s===this._$Ej?.get(e)&&!this.hasAttribute(r._$Eu(e,i))))return;this.C(e,t,i)}this.isUpdatePending===!1&&(this._$ES=this._$EP())}C(e,t,{useDefault:i,reflect:n,wrapped:s},r){i&&!(this._$Ej??=new Map).has(e)&&(this._$Ej.set(e,r??t??this[e]),s!==!0||r!==void 0)||(this._$AL.has(e)||(this.hasUpdated||i||(t=void 0),this._$AL.set(e,t)),n===!0&&this._$Em!==e&&(this._$Eq??=new Set).add(e))}async _$EP(){this.isUpdatePending=!0;try{await this._$ES}catch(t){Promise.reject(t)}let e=this.scheduleUpdate();return e!=null&&await e,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){if(!this.isUpdatePending)return;if(!this.hasUpdated){if(this.renderRoot??=this.createRenderRoot(),this._$Ep){for(let[n,s]of this._$Ep)this[n]=s;this._$Ep=void 0}let i=this.constructor.elementProperties;if(i.size>0)for(let[n,s]of i){let{wrapped:r}=s,l=this[n];r!==!0||this._$AL.has(n)||l===void 0||this.C(n,void 0,s,l)}}let e=!1,t=this._$AL;try{e=this.shouldUpdate(t),e?(this.willUpdate(t),this._$EO?.forEach(i=>i.hostUpdate?.()),this.update(t)):this._$EM()}catch(i){throw e=!1,this._$EM(),i}e&&this._$AE(t)}willUpdate(e){}_$AE(e){this._$EO?.forEach(t=>t.hostUpdated?.()),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(e)),this.updated(e)}_$EM(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$ES}shouldUpdate(e){return!0}update(e){this._$Eq&&=this._$Eq.forEach(t=>this._$ET(t,this[t])),this._$EM()}updated(e){}firstUpdated(e){}};N.elementStyles=[],N.shadowRootOptions={mode:"open"},N[at("elementProperties")]=new Map,N[at("finalized")]=new Map,ai?.({ReactiveElement:N}),(ft.reactiveElementVersions??=[]).push("2.1.2");var Pt=globalThis,$e=a=>a,bt=Pt.trustedTypes,we=bt?bt.createPolicy("lit-html",{createHTML:a=>a}):void 0,Ee="$lit$",W=`lit$${Math.random().toFixed(9).slice(2)}$`,ze="?"+W,oi=`<${ze}>`,j=document,lt=()=>j.createComment(""),ct=a=>a===null||typeof a!="object"&&typeof a!="function",Ft=Array.isArray,li=a=>Ft(a)||typeof a?.[Symbol.iterator]=="function",At=`[ 	
\f\r]`,ot=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,_e=/-->/g,ke=/>/g,K=RegExp(`>|${At}(?:([^\\s"'>=/]+)(${At}*=${At}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),Se=/'/g,Ae=/"/g,Le=/^(?:script|style|textarea|title)$/i,Mt=a=>(e,...t)=>({_$litType$:a,strings:e,values:t}),o=Mt(1),X=Mt(2),Gi=Mt(3),q=Symbol.for("lit-noChange"),u=Symbol.for("lit-nothing"),Ce=new WeakMap,G=j.createTreeWalker(j,129);function Te(a,e){if(!Ft(a)||!a.hasOwnProperty("raw"))throw Error("invalid template strings array");return we!==void 0?we.createHTML(e):e}var ci=(a,e)=>{let t=a.length-1,i=[],n,s=e===2?"<svg>":e===3?"<math>":"",r=ot;for(let l=0;l<t;l++){let c=a[l],p,d,m=-1,f=0;for(;f<c.length&&(r.lastIndex=f,d=r.exec(c),d!==null);)f=r.lastIndex,r===ot?d[1]==="!--"?r=_e:d[1]!==void 0?r=ke:d[2]!==void 0?(Le.test(d[2])&&(n=RegExp("</"+d[2],"g")),r=K):d[3]!==void 0&&(r=K):r===K?d[0]===">"?(r=n??ot,m=-1):d[1]===void 0?m=-2:(m=r.lastIndex-d[2].length,p=d[1],r=d[3]===void 0?K:d[3]==='"'?Ae:Se):r===Ae||r===Se?r=K:r===_e||r===ke?r=ot:(r=K,n=void 0);let x=r===K&&a[l+1].startsWith("/>")?" ":"";s+=r===ot?c+oi:m>=0?(i.push(p),c.slice(0,m)+Ee+c.slice(m)+W+x):c+W+(m===-2?l:x)}return[Te(a,s+(a[t]||"<?>")+(e===2?"</svg>":e===3?"</math>":"")),i]},pt=class a{constructor({strings:e,_$litType$:t},i){let n;this.parts=[];let s=0,r=0,l=e.length-1,c=this.parts,[p,d]=ci(e,t);if(this.el=a.createElement(p,i),G.currentNode=this.el.content,t===2||t===3){let m=this.el.content.firstChild;m.replaceWith(...m.childNodes)}for(;(n=G.nextNode())!==null&&c.length<l;){if(n.nodeType===1){if(n.hasAttributes())for(let m of n.getAttributeNames())if(m.endsWith(Ee)){let f=d[r++],x=n.getAttribute(m).split(W),y=/([.?@])?(.*)/.exec(f);c.push({type:1,index:s,name:y[2],strings:x,ctor:y[1]==="."?Et:y[1]==="?"?zt:y[1]==="@"?Lt:J}),n.removeAttribute(m)}else m.startsWith(W)&&(c.push({type:6,index:s}),n.removeAttribute(m));if(Le.test(n.tagName)){let m=n.textContent.split(W),f=m.length-1;if(f>0){n.textContent=bt?bt.emptyScript:"";for(let x=0;x<f;x++)n.append(m[x],lt()),G.nextNode(),c.push({type:2,index:++s});n.append(m[f],lt())}}}else if(n.nodeType===8)if(n.data===ze)c.push({type:2,index:s});else{let m=-1;for(;(m=n.data.indexOf(W,m+1))!==-1;)c.push({type:7,index:s}),m+=W.length-1}s++}}static createElement(e,t){let i=j.createElement("template");return i.innerHTML=e,i}};function Q(a,e,t=a,i){if(e===q)return e;let n=i!==void 0?t._$Co?.[i]:t._$Cl,s=ct(e)?void 0:e._$litDirective$;return n?.constructor!==s&&(n?._$AO?.(!1),s===void 0?n=void 0:(n=new s(a),n._$AT(a,t,i)),i!==void 0?(t._$Co??=[])[i]=n:t._$Cl=n),n!==void 0&&(e=Q(a,n._$AS(a,e.values),n,i)),e}var Ct=class{constructor(e,t){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){let{el:{content:t},parts:i}=this._$AD,n=(e?.creationScope??j).importNode(t,!0);G.currentNode=n;let s=G.nextNode(),r=0,l=0,c=i[0];for(;c!==void 0;){if(r===c.index){let p;c.type===2?p=new dt(s,s.nextSibling,this,e):c.type===1?p=new c.ctor(s,c.name,c.strings,this,e):c.type===6&&(p=new Tt(s,this,e)),this._$AV.push(p),c=i[++l]}r!==c?.index&&(s=G.nextNode(),r++)}return G.currentNode=j,n}p(e){let t=0;for(let i of this._$AV)i!==void 0&&(i.strings!==void 0?(i._$AI(e,i,t),t+=i.strings.length-2):i._$AI(e[t])),t++}},dt=class a{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(e,t,i,n){this.type=2,this._$AH=u,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=i,this.options=n,this._$Cv=n?.isConnected??!0}get parentNode(){let e=this._$AA.parentNode,t=this._$AM;return t!==void 0&&e?.nodeType===11&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=Q(this,e,t),ct(e)?e===u||e==null||e===""?(this._$AH!==u&&this._$AR(),this._$AH=u):e!==this._$AH&&e!==q&&this._(e):e._$litType$!==void 0?this.$(e):e.nodeType!==void 0?this.T(e):li(e)?this.k(e):this._(e)}O(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}T(e){this._$AH!==e&&(this._$AR(),this._$AH=this.O(e))}_(e){this._$AH!==u&&ct(this._$AH)?this._$AA.nextSibling.data=e:this.T(j.createTextNode(e)),this._$AH=e}$(e){let{values:t,_$litType$:i}=e,n=typeof i=="number"?this._$AC(e):(i.el===void 0&&(i.el=pt.createElement(Te(i.h,i.h[0]),this.options)),i);if(this._$AH?._$AD===n)this._$AH.p(t);else{let s=new Ct(n,this),r=s.u(this.options);s.p(t),this.T(r),this._$AH=s}}_$AC(e){let t=Ce.get(e.strings);return t===void 0&&Ce.set(e.strings,t=new pt(e)),t}k(e){Ft(this._$AH)||(this._$AH=[],this._$AR());let t=this._$AH,i,n=0;for(let s of e)n===t.length?t.push(i=new a(this.O(lt()),this.O(lt()),this,this.options)):i=t[n],i._$AI(s),n++;n<t.length&&(this._$AR(i&&i._$AB.nextSibling,n),t.length=n)}_$AR(e=this._$AA.nextSibling,t){for(this._$AP?.(!1,!0,t);e!==this._$AB;){let i=$e(e).nextSibling;$e(e).remove(),e=i}}setConnected(e){this._$AM===void 0&&(this._$Cv=e,this._$AP?.(e))}},J=class{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(e,t,i,n,s){this.type=1,this._$AH=u,this._$AN=void 0,this.element=e,this.name=t,this._$AM=n,this.options=s,i.length>2||i[0]!==""||i[1]!==""?(this._$AH=Array(i.length-1).fill(new String),this.strings=i):this._$AH=u}_$AI(e,t=this,i,n){let s=this.strings,r=!1;if(s===void 0)e=Q(this,e,t,0),r=!ct(e)||e!==this._$AH&&e!==q,r&&(this._$AH=e);else{let l=e,c,p;for(e=s[0],c=0;c<s.length-1;c++)p=Q(this,l[i+c],t,c),p===q&&(p=this._$AH[c]),r||=!ct(p)||p!==this._$AH[c],p===u?e=u:e!==u&&(e+=(p??"")+s[c+1]),this._$AH[c]=p}r&&!n&&this.j(e)}j(e){e===u?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e??"")}},Et=class extends J{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===u?void 0:e}},zt=class extends J{constructor(){super(...arguments),this.type=4}j(e){this.element.toggleAttribute(this.name,!!e&&e!==u)}},Lt=class extends J{constructor(e,t,i,n,s){super(e,t,i,n,s),this.type=5}_$AI(e,t=this){if((e=Q(this,e,t,0)??u)===q)return;let i=this._$AH,n=e===u&&i!==u||e.capture!==i.capture||e.once!==i.once||e.passive!==i.passive,s=e!==u&&(i===u||n);n&&this.element.removeEventListener(this.name,this,i),s&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){typeof this._$AH=="function"?this._$AH.call(this.options?.host??this.element,e):this._$AH.handleEvent(e)}},Tt=class{constructor(e,t,i){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=i}get _$AU(){return this._$AM._$AU}_$AI(e){Q(this,e)}};var pi=Pt.litHtmlPolyfillSupport;pi?.(pt,dt),(Pt.litHtmlVersions??=[]).push("3.3.3");var Pe=(a,e,t)=>{let i=t?.renderBefore??e,n=i._$litPart$;if(n===void 0){let s=t?.renderBefore??null;i._$litPart$=n=new dt(e.insertBefore(lt(),s),s,void 0,t??{})}return n._$AI(a),n};var Rt=globalThis,I=class extends N{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){let e=super.createRenderRoot();return this.renderOptions.renderBefore??=e.firstChild,e}update(e){let t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Do=Pe(t,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return q}};I._$litElement$=!0,I.finalized=!0,Rt.litElementHydrateSupport?.({LitElement:I});var di=Rt.litElementPolyfillSupport;di?.({LitElement:I});(Rt.litElementVersions??=[]).push("4.2.2");var h={label:"rgba(242,247,243,0.56)",value:"rgba(242,247,243,0.97)",muted:"rgba(242,247,243,0.46)",logLabel:"rgba(242,247,243,0.72)",logText:"rgba(242,247,243,0.90)",ok:"#7BE8A8",warn:"#FFCE7A",crit:"#FF9D9D",info:"#9AC8FF",water:"#7CC8F0",light:"#FFDC8A",temp:"#FFB98A",heat:"#FFB35C",tileBg:"rgba(255,255,255,0.04)",rowBg:"rgba(255,255,255,0.035)"},Ot={critical:"rgba(255,157,157,.14)",warning:"rgba(255,206,122,.12)",info:"rgba(154,200,255,.10)",ok:h.rowBg,none:"rgba(255,255,255,.022)"},Fe={critical:h.crit,warning:h.warn,info:h.info,ok:h.logText,none:"rgba(242,247,243,.36)"},Bt={Aus:{bg:"rgba(150,170,160,0.12)",color:"#8EA89C"},Seedling:{bg:"rgba(154,200,255,0.16)",color:"#9AC8FF"},Veg:{bg:"rgba(123,232,168,0.16)",color:"#7BE8A8"},Bloom:{bg:"rgba(255,185,138,0.18)",color:"#FFB98A"},Flush:{bg:"rgba(195,171,245,0.18)",color:"#C3ABF5"},Trocknung:{bg:"rgba(211,168,120,0.18)",color:"#D3A878"}},It={soft_garden:{label:"Soft Garden (Standard)",top:"#202C25",card:"#1B2620",card2:"#222F28",card3:"#17211B",line:"#2E3D34",lineSoft:"#27342C",tx:"#F2F7F3",tx2:"#B9CCC0",tx3:"#85998C"},graphite:{label:"Graphite",top:"#20242A",card:"#191C21",card2:"#232830",card3:"#15181C",line:"#313842",lineSoft:"#2A3038",tx:"#F2F4F7",tx2:"#C2C8D0",tx3:"#8A919B"},midnight:{label:"Midnight",top:"#1A2233",card:"#141A28",card2:"#1E2740",card3:"#111626",line:"#2B3958",lineSoft:"#25304A",tx:"#EFF3FB",tx2:"#BCC8DE",tx3:"#8492AC"},plum:{label:"Plum",top:"#241F2E",card:"#1B1726",card2:"#261F36",card3:"#16121F",line:"#382E4A",lineSoft:"#2F273E",tx:"#F4F0FA",tx2:"#C9C0D8",tx3:"#978AA8"},terra:{label:"Terra",top:"#2A2420",card:"#201A16",card2:"#2C2420",card3:"#1A1410",line:"#3D332B",lineSoft:"#332A24",tx:"#F7F3EF",tx2:"#D0C8C0",tx3:"#9B918A"},slate_teal:{label:"Slate Teal",top:"#1C2A2A",card:"#142020",card2:"#1E2E2E",card3:"#111A1A",line:"#2B4040",lineSoft:"#243434",tx:"#EFF7F6",tx2:"#BCD2D0",tx3:"#84A09E"},rose_noir:{label:"Ros\xE9 Noir",top:"#2A1F24",card:"#201619",card2:"#2C1F25",card3:"#1A1216",line:"#3D2B33",lineSoft:"#33242B",tx:"#FAF0F3",tx2:"#D8C0C8",tx3:"#A88A95"},ink:{label:"Ink",top:"#1A1C1E",card:"#131517",card2:"#1D2023",card3:"#0F1113",line:"#2C3137",lineSoft:"#252A2F",tx:"#F4F6F8",tx2:"#C4CACF",tx3:"#8B9298"}},ui=a=>{if(!a||a==="soft_garden")return"";let e=It[a];return e?[`--gc-bg:linear-gradient(180deg, ${e.top}, ${e.card} 30%)`,`--card:${e.card}`,`--card-2:${e.card2}`,`--card-3:${e.card3}`,`--line:${e.line}`,`--line-soft:${e.lineSoft}`,`--tx:${e.tx}`,`--tx-2:${e.tx2}`,`--tx-3:${e.tx3}`].join(";"):""},L=a=>{let e=[],t=ui(a?.palette);if(t&&e.push(t),a?.background){let i=a.background.trim(),n=i.includes(",")&&!/^(linear|radial|conic|rgb|hsl)/i.test(i)?`linear-gradient(160deg, ${i})`:i;e.push(`--gc-bg:${n}`)}return a?.opacity!==void 0&&e.push(`--gc-opacity:${a.opacity}`),a?.accent&&e.push(`--gc-accent:${a.accent}`),a?.radius!==void 0&&e.push(`--gc-radius:${a.radius}px`),e.join(";")},tt=a=>a.includes("critical")?"critical":a.includes("warning")?"warning":a.includes("info")?"info":"ok",D=a=>({ok:"ok",info:"info",warning:"warn",critical:"crit",none:"none"})[a]??"ok",T=rt`
  :host {
    display:block;
...
`,ln={ok:{bg:"rgba(123,232,168,.14)",color:h.ok,label:"Alles OK"},info:{bg:"rgba(154,200,255,.14)",color:h.info,label:"Info"},warning:{bg:"rgba(255,206,122,.14)",color:h.warn,label:"Warnung"},critical:{bg:"rgba(255,157,157,.16)",color:h.crit,label:"Kritisch"},none:{bg:"rgba(133,153,140,.14)",color:"#85998C",label:"Inaktiv"}};var hi="4d72-4461726b-766f6964",Re=()=>hi,Me,xt=null;function vt(a){if(a?.states===Me&&xt)return xt;let e=new Map,t=new Set,i={};for(let[n,s]of Object.entries(a?.states??{})){let r=s?.attributes;if(!r?.growctrl_role||!r?.growctrl_tent)continue;let l=String(r.growctrl_tent),c=String(r.growctrl_station??"zelt");e.set(`${l}::${c}::${r.growctrl_role}`,n),c==="zelt"?t.add(l):(i[l]??=new Set).add(c)}return Me=a?.states,xt={tents:[...t].sort(),stations:Object.fromEntries(Object.entries(i).map(([n,s])=>[n,[...s].sort()])),byRole:e},xt}var R=(a,e,t,i)=>vt(a).byRole.get(`${e}::${t}::${i}`);var z=class extends I{constructor(){super(...arguments);this._config={};this._label=t=>t.label??t.name}static{this.properties={hass:{attribute:!1},_config:{state:!0}}}static{this.styles=rt`
  ...
  `}setConfig(t){this._config={...t}}_fire(t){this._config=t,this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:t},bubbles:!0,composed:!0}))}form(t){return o`<ha-form .hass=${this.hass} .data=${this._config} .schema=${t}
    ...
    <circle cx="${m}" cy="${f}" r="2.6" fill="${e}"/>
      ...
      <button class="gc dd-btn" aria-haspopup="listbox" aria-expanded=${this._phase} @click=${()=>{this._phase=!this._phase}}>
        <span class="pdot ${De[i]}" style="${i==="Auto"?"background:var(--acc);color:var(--acc)":""}"></span>${this.t(i)}
        <span class="hint">${this.t(Ve[i]??"")}</span>
      ...
      <div class="hd">
        ...
        <span class="pill ${d?D(y):"none"}">${d?y==="ok"?this.t("Alles OK"):y==="warning"?this.t("Warnung"):this.t("Info"):this.t("Deaktiviert")}</span>
      </div>
      ...
      <div style="margin-top:16px">
        <div class="zones">
          ${Ue.map(P=>o`<i style="width:${P.w}%;background:${P.col}"></i>`)}
        ...
        <div class="zlbl">${Ue.map(P=>o`<span style="width:${P.w}%">${this.t(P.lbl)}</span>`)}</div>
      </div>

      <div style="display:flex; gap:12px; flex-wrap:wrap; margin-top:14px; align-items:center">
        <span class="mlbl">${this.t("Modus")}</span>${this.chips(this.e("mode"),bi,this.st(this.e("mode"))??"VPD")}
      </div>
      ...
      ${t.show_chart!==!1&&this._hist.length>1?o`
        ...
        ${H([{data:this._hist,color:v===!1?h.warn:h.ok,fill:!0}],{w:this.chartW(),h:96,band:p?{min:p.vpd_min,max:p.vpd_max}:void 0,grid:3})}`:u}

      ${x.length?o`<div style="display:flex; flex-wrap:wrap; gap:7px; margin-top:12px">
        ${x.map(P=>o`<span class="pbadge warn"><ha-icon icon="mdi:alert" style="--mdc-icon-size:12px"></ha-icon>${P}</span>`)}</div>`:u}
      ...
      ${this.renderConfirm()}
    </div>`}};customElements.define("growctrl-tent-card",Wt);var Zt=class extends z{render(){let e=[this.tentSelect("tent","\u{1F3D5}\uFE0F Zelt"),this.stationSelect(this._config?.tent,"station","\u{1F331} Station (= Pflanze)"),g.text("name","\u270F\uFE0F Anzeigename (optional)"),g.bool("show_settings","\u2699\uFE0F Einstellungen-Zahnrad anzeigen"),g.bool("show_log","\u{1F4DC} Protokoll-Auszug am Kartenfu\xDF (Standard an)"),g.bool("start_expanded","\u{1F4C2} Bereiche beim Laden ge\xF6ffnet (Standard: zu)"),g.entity("tank_entity","\u{1F4A7} Stations-Tank F\xFCllstand % (optional)","sensor"),g.num("tank_min","\u26A0\uFE0F Tank-Mindeststand %",0,100),g.num("tank_volume","\u{1FAA3} Tank-Volumen in Litern (optional)",1,1e4),g.entity("camera_entity","\u{1F4F9} Livestream-Kamera (optional)","camera"),g.text("image_url","\u{1F5BC}\uFE0F oder Bild-URL (optional, statt Kamera)"),g.num("media_height","\u2195\uFE0F H\xF6he des Feeds in px (Standard 180)",60,600)],t=[g.entity("entity","\u{1F50C} Schalter",["switch","input_boolean","light","fan"]),g.text("name","\u270F\uFE0F Anzeigename (optional)"),g.select("kind","\u{1F3A8} Art (Farbe/Icon)",[{value:"light",label:"Licht"},{value:"pump",label:"Pumpe"},{value:"o2",label:"O\u2082"},{value:"fan",label:"L\xFCfter"},{value:"heat",label:"Heizmatte"},{value:"water",label:"Befeuchter"}]),g.bool("confirm","\u2705 Vor dem Schalten best\xE4tigen")],i=[g.entity("entity","\u{1F4C8} Sensor / input_number"),g.text("name","\u270F\uFE0F Anzeigename (optional)"),g.text("icon","\u{1F3F7}\uFE0F Icon (z.B. mdi:thermometer, optional)"),g.select("anzeige","\u{1F4CA} Anzeige",[{value:"wert",label:"Wert"},{value:"graph",label:"Mini-Verlauf"}])];return o`${this.form(e)}
      ...
      </div>`}};customElements.define("growctrl-station-editor",Zt);var vi=["Aus","Seedling","Veg","Bloom","Flush","Trocknung"],We=72,yi={Aus:"gestoppt",Seedling:"Anzucht",Veg:"Wachstum",Bloom:"Bl\xFCte",Flush:"Sp\xFClen",Trocknung:"Ernte"},Ze={Aus:"Aus",Seedling:"Anzucht",Veg:"Wachstum",Bloom:"Bl\xFCte",Flush:"Sp\xFClen",Trocknung:"Trocknung"},$i={Aus:"pd-off",Seedling:"pd-seed",Veg:"pd-veg",Bloom:"pd-bloom",Flush:"pd-flush",Trocknung:"pd-dry"},wi={light:"mdi:lightbulb",heat:"mdi:radiator",water:"mdi:air-humidifier",pump:"mdi:water-pump",fan:"mdi:fan",o2:"mdi:scuba-tank"},Kt=class extends S{constructor(){super(...arguments);this._open=!1;this._phase=!1;this._plant=!1;this._exp={};this._spark={};this._tankHist=[]}static{this.styles=T}static{this.properties={...S.properties,_open:{state:!0},_spark:{state:!0},_phase:{state:!0},_plant:{state:!0},_exp:{state:!0},_tankHist:{state:!0}}}expOpen(t){return this._exp[t]??!!this._config?.start_expanded}updated(t){if(super.updated?.(t),!t.has("hass")&&!t.has("_config"))return;this.allSensors().forEach(async n=>{let s=await M(this.hass,n.entity,n.hours??24);s.length&&this._spark[n.entity]?.length!==s.length&&(this._spark={...this._spark,[n.entity]:s})});let i=this._config.tank_entity;i&&(async()=>{let n=await M(this.hass,i,We);n.length&&n.length!==this._tankHist.length&&(this._tankHist=n)})()}tankDaysLeft(t,i){let n=this._tankHist;if(!n||n.length<4||t<=i)return null;let s=0;for(let l=1;l<n.length;l++){let c=n[l-1]-n[l];c>0&&(s+=c)}let r=s/(We/24);return r<.4?null:(t-i)/r}trendArrow(t){if(!t||t.length<4)return null;let i=Math.max(2,Math.floor(t.length/4)),n=d=>d.reduce((m,f)=>m+f,0)/d.length,s=n(t.slice(-i))-n(t.slice(0,i)),r=Math.max(...t)-Math.min(...t)||1,l=s/r,c=Math.max(1,Math.min(1.45,1+((this._cw||360)-390)/500)),p=Math.round(16*c);return l>.06?{icon:"mdi:menu-up",color:h.temp,size:p}:l<-.06?{icon:"mdi:menu-down",color:h.water,size:p}:{icon:"mdi:menu-right",color:"var(--tx-3)",size:p}}validateConfig(t){if(!t.tent||!t.station)throw new Error("growctrl-station-card: 'tent' und 'station' sind Pflicht (wie in der Integration angelegt).")}static getConfigElement(){return document.createElement("growctrl-station-editor")}static getStubConfig(){return{tent:"gross",station:"main1"}}get isPreview(){return!this.hass?.states?.[this.e("stage")]}e(t){let[i,n,s]=$t[t];return this.eRole(i,n,s)}eRole(t,i,n){let s=this._config;return s.overrides?.[i]??R(this.hass,s.tent,s.station,n)??Z(t,s.tent,s.station,i,s.overrides)}_select(t,i){this.hass.callService("select","select_option",{entity_id:t,option:i})}render(){let t=this._config;if(!this.hass)return u;let i=this.isPreview,n=this.st(this.e("stage"))??"Veg",s=Bt[n]??Bt.Veg,r=this.isOn(this.e("auto"))||i,l=this.isOn(this.e("wartung")),c=R(this.hass,t.tent,"zelt","tent_enabled")??U("switch",t.tent,"tent_enabled",t.overrides),p=!!this.hass.states[c]&&!this.isOn(c),d=n==="Aus",m=p||d,f=!r||l||p||d,x=[{e:this.e("pOverride"),label:"Manueller Eingriff",crit:!1},{e:this.e("pFailsafe"),label:"Licht-Failsafe",crit:!0},{e:this.e("pTime"),label:"Zeiten unvollst\xE4ndig",crit:!1},{e:this.e("pPump"),label:"Pumpe gesperrt (F\xFCllstand)",crit:!1},{e:this.e("pPower"),label:"Licht ohne Leistung",crit:!0}].filter(_=>this.isOn(_.e)),y=this.hass.states[this.e("event")],$=m?"warning":x.length?x.some(_=>_.crit)?"critical":"warning":y?.attributes?.schweregrad==="critical"?"warning":"ok",v=l?this.t("Wartung aktiv"):p?this.t("Zelt aus \u2013 gestoppt"):d?this.t("Station aus"):$==="critical"?this.t("Kritisch"):$==="warning"?this.t("Warnung"):this.t("Alles OK"),k=Math.max(1,Math.min(1.45,1+((this._cw||360)-390)/500));return o`<div class="card ${t.style?.glass?"glass":""}" data-level=${$} style="${L(t.style)};--gc-sc:${k.toFixed(3)};position:relative">
    ...
    </div>`}phaseDropdown(t,i){let n=C(this.st(this.e("age"))),s=this.hass.states[this.e("stage")]?.attributes?.phasen_bis??{},r=c=>{let p=s[c];return typeof p=="number"?`${this.t("bis Tag")} ${p}`:c==="Aus"||c==="Trocknung"?this.t(yi[c]??""):""},l=n!==null?`${this.t("Tag")} ${n}`:r(t);return o`<div class="dd ${this._phase?"open":""}">
      <button class="gc dd-btn" aria-haspopup="listbox" aria-expanded=${this._phase}
        @click=${()=>{this._phase=!this._phase,this._plant=!1}}>
        <span class="pdot" style="background:${i.color};color:${i.color}"></span>${this.t(Ze[t]??t)}
        <span class="hint">${l}</span>
        <ha-icon icon="mdi:chevron-down" style="--mdc-icon-size:16px;color:var(--tx-3);transition:transform .2s;${this._phase?"transform:rotate(180deg)":""}"></ha-icon>
      </button>
      ${this._phase?o`<div class="dd-menu" role="listbox">
        ${vi.map(c=>o`<button class="gc dd-it" role="option" aria-selected=${c===t}
          @click=${()=>{this._select(this.e("stage"),c),this._phase=!1}}>
          <span class="pdot ${$i[c]}"></span>${this.t(Ze[c]??c)}<span class="hint">${r(c)}</span></button>`)}
      </div>`:u}
    ...
    </button>`}lightRow(){if(this.isPreview)return this.supplyRow({icon:"mdi:lightbulb-on",iconColor:h.light,glow:!0,title:this.t("Licht an"),value:"5 h 40 min",valueColor:h.light,fillPct:62,fillColor:h.light,footL:this.t("Leuchtphase"),footR:`62 % ${this.t("verbleibend")}`});let t=this.hass.states[this.e("lightRest")];if(!t)return u;let i=t.attributes??{},n=i.zustand?i.zustand==="an":void 0,s=Number(t.state),r=isNaN(s)?"\u2013":yt(s),l=typeof i.anteil=="number"?Math.min(1,Math.max(0,i.anteil)):null,c=n===!1?"#7E9488":h.light;return this.supplyRow({icon:n===!1?"mdi:lightbulb-outline":"mdi:lightbulb-on",iconColor:c,glow:n!==!1,title:n===!1?this.t("Licht aus"):this.t("Licht an"),value:n===!1?"\u2013":r,valueColor:c,fillPct:n===!1?null:l!==null?l*100:null,fillColor:c,footL:n===!1?this.t("Licht ausgeschaltet"):this.t("Leuchtphase"),footR:n===!1?"":l!==null?`${(l*100).toFixed(0)} % ${this.t("verbleibend")}`:"",onClick:()=>this.moreInfo(this.e("lightRest"))})}dliRow(t){let i=this.hass.states[this.e("dli")];if(!i&&!t)return u;let n=C(this.st(this.e("dli")))??(t?18.4:null),s=C(this.st(this.e("dliFc")))??(t?24.7:null),r=i?.attributes?.ziel_aktuelle_phase??(t?25:void 0),l=r&&n!==null?n/r*100:null,c=r&&s!==null?Math.min(100,s/r*100):void 0,p=l!==null&&l>100,d=p?"#FFB35C":h.light;return this.supplyRow({icon:"mdi:white-balance-sunny",iconColor:d,topMargin:!0,title:this.t("DLI heute"),value:n!==null?`${n.toFixed(1)}${r?` / ${r}`:""}`:"\u2013",valueColor:d,fillPct:l,fillColor:d,minPct:c,footL:s!==null?`${this.t("Prognose")} ${s.toFixed(1)} mol/m\xB2`:"",footR:p?`${this.t("\xFCber Ziel")} +${(l-100).toFixed(0)} %`:r?this.t("Marker = Prognose"):"",onClick:()=>this.moreInfo(this.e("dli"))})}heatRow(t){if(this.isPreview)return u;let i=this.hass.states[this.e("heatActive")];if(!i)return u;let n=i.attributes??{},s=n.aktiv!==!1&&this.isOn(this.e("heatEnabled")),r=i.state==="on",l=typeof n.ist_temp=="number"?n.ist_temp:null,c=typeof n.ziel_temp=="number"?n.ziel_temp:null,p=typeof n.hysterese=="number"?n.hysterese:.5,d,m,f,x,y,$=null,v;if(n.sensorfehler)d="mdi:thermometer-alert",m=h.crit,f=this.t("Heizung Sensorfehler"),x=this.t("Regelf\xFChler fehlt \u2013 Heizung gesperrt"),y="";else if(n.uebertemperatur)d="mdi:thermometer-alert",m=h.crit,f=this.t("Heizung \xDCbertemperatur"),x=this.t("Not-Aus \u2013 zu hei\xDF"),y=c!==null?`${this.t("Ziel")} ${c} \xB0C`:"";else if(t)d="mdi:radiator-off",m="#7E9488",f=this.t("Heizung gesperrt"),x=this.t("Automatik/Zelt aus \u2013 manuell freigeben"),y=c!==null?`${this.t("Ziel")} ${c} \xB0C`:"";else if(m=s?h.heat:"#7E9488",d=r?"mdi:radiator":s?"mdi:radiator-disabled":"mdi:radiator-off",f=s?r?this.t("Heizung heizt"):this.t("Heizung bereit"):this.t("Heizung aus"),x=s?c!==null?`${this.t("Ziel")} ${c} \xB0C \xB1${p} K`:this.t("Germination-Heizung"):this.t("Heizung ausgeschaltet"),y=s?r?this.t("heizt"):this.t("bereit"):"",s&&l!==null&&c!==null){let A=c-4,P=c+1;$=(l-A)/(P-A)*100,v=Math.min(100,Math.max(0,(c-A)/(P-A)*100))}let k=l!==null?`${l.toFixed(1)} \xB0C`:"\u2013",_=()=>this.moreInfo(this.e("heatActive"));return o`
      <div class="gc supply" style="margin-top:8px">
        <div class="shd">
          <span class="sic" style="color:${m};${r?`filter:drop-shadow(0 0 7px ${m})`:""}" @click=${_}>
            <ha-icon icon="${d}" style="--mdc-icon-size:20px"></ha-icon></span>
          <span class="stt" style="cursor:pointer" @click=${_}>${f}</span>
          <span class="stm" style="color:${m};cursor:pointer" @click=${_}>${k}</span>
      ...
      <ha-icon icon="${n?"mdi:chevron-up":"mdi:chevron-down"}" style="--mdc-icon-size:calc(20px * var(--gc-sc,1));color:var(--tx-3)"></ha-icon>
    </button>`}actuators(){let t=this._config.actuators??[];return t.length?this.expOpen("actuators")?o`
      ${this.expHeader("actuators","Aktoren")}
      <div class="acts">
        ${t.map(i=>{let n=this.isOn(i.entity),s=i.kind??"",r=i.icon??wi[s]??"mdi:power",l=i.name??this.friendly(i.entity);return o`<button class="gc act ${n?"on":""} ${n&&s?s:""}" style="position:relative"
        ...
        <div style="display:flex;flex-wrap:wrap;gap:11px;padding:2px 2px 0">
          ${t.map(i=>{let n=this.isOn(i.entity);return o`<span style="display:inline-flex;align-items:center;gap:6px;font:800 calc(11.5px * var(--gc-sc,1)) var(--f-ui);color:var(--tx-2)">
              <span style="width:calc(11px * var(--gc-sc,1));height:calc(11px * var(--gc-sc,1));border-radius:50%;flex-shrink:0;background:${n?h.ok:"var(--tx-3)"};${n?`box-shadow:0 0 calc(8px * var(--gc-sc,1)) ${h.ok}`:""}"></span>
      ...
      <div style="display:flex;flex-wrap:wrap;gap:12px;padding:2px 2px 0">
        ${t.map(i=>{let n=C(this.st(i.entity)),s=i.anzeige??"wert",r,l=!0;if(s==="zone"){let c=i.ideal??[0,0],p=i.ok??c;r=i.color??(n!==null&&n>=c[0]&&n<=c[1]?h.ok:n!==null&&n>=p[0]&&n<=p[1]?h.warn:h.crit),l=!1}else r=i.color??"var(--tx-3)";return o`<span style="display:inline-flex;align-items:center;gap:5px;font:800 calc(12px * var(--gc-sc,1)) var(--f-num);color:var(--tx-2)">
      ...
      </div>`:u}zoneV6(t,i,n,s,r){let l=n-i||1,c=(m,f)=>Math.max(0,(Math.min(f,n)-Math.max(m,i))/l*100),p=[{cls:"z-bad",w:c(i,s[0])},{cls:"z-low",w:c(s[0],r[0])},{cls:"z-ok",w:c(r[0],r[1])},{cls:"z-high",w:c(r[1],s[1])},{cls:"z-bad",w:c(s[1],n)}],d=t!==null?Math.min(100,Math.max(0,(t-i)/l*100)):null;return o`
      <span class="zones">
        ${p.map(m=>o`<i class="${m.cls}" style="width:${m.w}%"></i>`)}
      ...
      </span>`}sensorInd(t){let i=C(this.st(t.entity)),n=t.name??this.friendly(t.entity),s=this.unit(t.entity),r=t.anzeige??"wert",l=t.entity.split(".")[0],c=l==="number"||l==="input_number",p=this.hass.states[t.entity]?.attributes??{},d=t.step??(Number(p.step)||.1),m=p.min,f=p.max,x=(String(d).split(".")[1]??"").length||1,y=E=>{let b=E;m!==void 0&&(b=Math.max(m,b)),f!==void 0&&(b=Math.min(f,b)),this.hass.callService(l,"set_value",{entity_id:t.entity,value:Number(b.toFixed(x))})},$,v=t.ideal??[0,0],k=t.ok??v;if(r==="zone"){let E=i!==null&&i>=v[0]&&i<=v[1],b=i!==null&&i>=k[0]&&i<=k[1];$=t.color??(E?h.ok:b?h.warn:h.crit)}else r==="graph"?$=t.color??h.water:$=t.color??"rgba(242,247,243,.95)";let _=this.trendArrow(this._spark[t.entity]),A=_?o`<ha-icon icon="${_.icon}" title=${this.t("Trend")}
          style="--mdc-icon-size:${_.size}px;color:${_.color};margin-right:3px;vertical-align:-3px"></ha-icon>`:u,P=o`<div class="ihd">
      ...
      ${c?o`<span class="setrow">
            <button class="gc stepbtn" title=${this.t("weniger")} @click=${E=>{E.stopPropagation(),i!==null&&y(i-d)}}><ha-icon icon="mdi:minus" style="--mdc-icon-size:16px"></ha-icon></button>
            <span class="setval" style="color:${$}">${A}${i!==null?i:"\u2013"}<span class="u">${s}</span></span>
            <button class="gc stepbtn" title=${this.t("mehr")} @click=${E=>{E.stopPropagation(),y((i??m??0)+d)}}><ha-icon icon="mdi:plus" style="--mdc-icon-size:16px"></ha-icon></button></span>`:o`<span class="ival" style="color:${$}">
            ${A}${i!==null?i:this.st(t.entity)??"\u2013"}<span class="u">${s}</span></span>`}
    </div>`,w=r==="zone"?o`${this.zoneV6(i,t.min??0,t.max??14,k,v)}
          ${(this._spark[t.entity]?.length??0)>1?o`<div class="spark" style="margin-top:7px;opacity:.85">${Dt(this._spark[t.entity],$,this.chartW(74),28)}</div>`:u}`:r==="graph"?o`<div class="spark">${Dt(this._spark[t.entity]??[],$,this.chartW(74),38)}</div>`:u;return o`<div class="ind" style="cursor:pointer" @click=${()=>this.moreInfo(t.entity)}>${P}${w}</div>`}mediaBlock(){let t=this._config,i=t.media_height??180;if(t.image_url)return o`<div class="seclbl">${this.t("Livestream")}</div>
        ...
        </button>`}return u}logExcerpt(){if(this._config.show_log===!1)return u;let n=this.hass.states[this.e("event")]?.attributes?.verlauf??[];if(!n.length)return u;let s=(this.expOpen("log")?n.slice(-3):n.slice(-1)).reverse();return o`${this.expHeader("log","Protokoll")}
      <div style="display:flex;flex-direction:column;gap:5px">
        ${s.map(r=>o`<button class="gc" @click=${()=>this.moreInfo(this.e("event"))}
          style="display:flex;align-items:center;gap:9px;width:100%;text-align:left;color:inherit;
            background:${Ot[r.level]??Ot.none};border:none;border-radius:9px;padding:9px 11px;min-height:38px">
      ...
      </div>`}todoBlock(){let t=this._config,i=R(this.hass,t.tent,"zelt","todo")??U("todo",t.tent,"aufgaben",t.overrides),n=this.hass.states[i]?.attributes?.aufgaben_offen??[],s=`${t.station}: `,r=n.filter(c=>c.text.startsWith(s)).map(c=>({uid:c.uid,text:c.text.slice(s.length)}));if(!r.length)return u;let l=this.expOpen("todo")?r:r.slice(0,1);return o`${this.expHeader("todo","Aufgaben")}
      <div style="display:flex;flex-direction:column;gap:5px">
    ...
    </div>`}};customElements.define("growctrl-station-card",Kt);var _i=[g.text("title","\u{1F3F7}\uFE0F Titel"),g.num("columns","\u25A6 Spalten",1,6)],ki=[g.entity("entity","\u{1F50C} Aktor",["switch","input_boolean","light","fan"]),g.text("name","\u270F\uFE0F Anzeigename (optional)"),g.text("group","\u{1F5C2}\uFE0F Gruppe (optional, z.B. Zelt / Pflanzen)"),g.select("kind","\u{1F3A8} Art (Farbe/Icon, optional)",[{value:"light",label:"Licht"},{value:"heat",label:"Heizung"},{value:"water",label:"Wasser / Befeuchter"},{value:"o2",label:"O\u2082"},{value:"fan",label:"L\xFCfter"},{value:"pump",label:"Pumpe"}]),g.bool("confirm","\u2705 Mit Best\xE4tigung schalten")],Gt=class extends z{render(){return o`${this.form(_i)}
      ${this.list({key:"controls",rowSchema:ki,title:"\u{1F50C} Aktoren",addLabel:"Aktor hinzuf\xFCgen",newItem:()=>({entity:""})})}
      ${this.styleSection()}
      <div class="hint">Gleiche <b>Gruppe</b> = gemeinsame \u00dcberschrift. <b>Art</b> setzt Farbe und Icon.
        <b>Best\u00e4tigung</b> fragt vor dem Schalten nach (z.B. f\u00fcr Pumpen).</div>`}};customElements.define("growctrl-controls-editor",Gt);var Si={switch:"mdi:power",light:"mdi:lightbulb",fan:"mdi:fan",input_boolean:"mdi:toggle-switch"},Ai={light:"mdi:lightbulb",heat:"mdi:radiator",water:"mdi:air-humidifier",o2:"mdi:scuba-tank",fan:"mdi:fan",pump:"mdi:water-pump"},jt=class extends S{static{this.styles=T}validateConfig(e){if(!Array.isArray(e.controls)||!e.controls.length)throw new Error("growctrl-controls-card: 'controls' (min. 1 Eintrag) ist Pflicht.")}static getConfigElement(){return document.createElement("growctrl-controls-editor")}static getStubConfig(){return{columns:4,controls:[{entity:"switch.demo_licht",kind:"light",name:"Licht"},{entity:"switch.demo_luefter",kind:"fan",name:"L\xFCfter"},{entity:"switch.demo_pumpe",kind:"pump",name:"Pumpe"},{entity:"switch.demo_heizung",kind:"heat",name:"Heizung"}]}}render(){let e=this._config;if(!this.hass)return u;let t=e.columns??4,i=new Map;return e.controls.forEach(n=>{let s=n.group??"";i.has(s)||i.set(s,[]),i.get(s).push(n)}),o`<div class="card ${e.style?.glass?"glass":""}" style="${L(e.style)};position:relative">
      ...
      ${[...i.entries()].map(([n,s])=>o`
        ...
        <div class="acts" style="grid-template-columns:repeat(${t},1fr); ${n?"":"margin-top:4px"}">
          ${s.map(r=>{let l=this.hass.states[r.entity]?this.isOn(r.entity):r.kind==="light"||r.kind==="fan",c=r.name??this.friendly(r.entity),p=r.kind??"",d=p==="light"||p==="heat"||p==="water"?p:"",m=r.icon??this.hass.states[r.entity]?.attributes?.icon??Ai[p]??Si[r.entity.split(".")[0]]??"mdi:power";return o`<button class="gc act ${l?"on":""} ${l?d:""}" style="position:relative"
      ...
      ${this.renderConfirm()}
    </div>`}};customElements.define("growctrl-controls-card",jt);var Ci=[g.text("title","\u{1F3F7}\uFE0F Titel"),g.num("columns","\u25A6 Spalten",1,6)],Ei=[g.entity("entity","\u{1F4C8} Sensor","sensor"),g.text("name","\u270F\uFE0F Anzeigename (optional)"),g.num("min","Sollbereich Min (optional)"),g.num("max","Sollbereich Max (optional)"),g.select("accent","\u{1F3A8} Akzentfarbe (optional)",[{value:"temp",label:"Temperatur (orange)"},{value:"hum",label:"Feuchte (blau)"},{value:"vpd",label:"VPD (Akzent)"}])],zi=[g.entity("entity","\u{1F4C8} Sensor (z.B. pH oder EC)","sensor"),g.text("name","\u270F\uFE0F Anzeigename (optional)"),g.num("min","Sollband Min (optional)"),g.num("max","Sollband Max (optional)"),g.num("hours","\u23F1\uFE0F Zeitraum in h (Standard 24)",1,168)],qt=class extends z{render(){return o`${this.form(Ci)}
      ${this.list({key:"sensors",rowSchema:Ei,title:"\u{1F4C8} Sensoren (Kacheln)",addLabel:"Sensor hinzuf\xFCgen",newItem:()=>({entity:""})})}
      ${this.list({key:"charts",rowSchema:zi,title:"\u{1F4C9} Verlaufs-Charts (z.B. pH & EC)",addLabel:"Chart hinzuf\xFCgen",newItem:()=>({entity:""})})}
      ${this.styleSection()}
      <div class="hint">Oben <b>Kacheln</b> mit aktuellem Wert. Darunter optionale <b>Verlaufs-Charts</b> \u2013
        f\u00fcge z.B. <b>pH</b> und <b>EC</b> hinzu; mit Min/Max wird ein Sollband eingezeichnet.</div>`}};customElements.define("growctrl-sensors-editor",qt);var Xt=class extends S{constructor(){super(...arguments);this._hist={}}static{this.styles=T}static{this.properties={...S.properties,_hist:{state:!0}}}validateConfig(t){if(!Array.isArray(t.sensors)||!t.sensors.length)throw new Error("growctrl-sensors-card: 'sensors' (min. 1 Eintrag) ist Pflicht.")}static getConfigElement(){return document.createElement("growctrl-sensors-editor")}static getStubConfig(){return{columns:3,sensors:[{entity:"sensor.demo_temp",name:"Temperatur",accent:"temp",min:20,max:28},{entity:"sensor.demo_hum",name:"Luftfeuchte",accent:"hum",min:50,max:70},{entity:"sensor.demo_vpd",name:"VPD",accent:"vpd",min:.8,max:1.5}]}}connectedCallback(){super.connectedCallback(),this._load(),this._timer=window.setInterval(()=>this._load(),5*6e4)}disconnectedCallback(){super.disconnectedCallback(),this._timer&&clearInterval(this._timer)}async _load(){if(!this.hass){setTimeout(()=>this._load(),1e3);return}let t=this._config.charts??[],i={};for(let n of t)i[n.entity]=await M(this.hass,n.entity,n.hours??24);this._hist=i}bad(t,i){return t!==null&&(i.min!==void 0&&t<i.min||i.max!==void 0&&t>i.max)}render(){let t=this._config;if(!this.hass)return u;let i=t.columns??3,n=[...t.sensors,...t.charts??[]].some(s=>this.bad(C(this.st(s.entity)),s));return o`<div class="card ${t.style?.glass?"glass":""}" data-level=${n?"warning":"ok"} style=${L(t.style)}>
      ${t.title?o`<div class="hd"><div class="ttl">${t.title}</div></div>`:u}
      <div class="kpis" style="grid-template-columns:repeat(${i},minmax(0,1fr))">
        ${t.sensors.map(s=>{let r=!this.hass.states[s.entity],l=C(this.st(s.entity))??(r?s.accent==="hum"?58:s.accent==="vpd"?1.1:23.4:null),c=this.unit(s.entity)||(r?s.accent==="hum"?"%":s.accent==="vpd"?"kPa":"\xB0C":""),p=this.bad(C(this.st(s.entity)),s),d=s.name??this.friendly(s.entity),m=s.accent?`c-${s.accent}`:"";return o`<button class="gc kpi ${m}" @click=${()=>this.moreInfo(s.entity)}>
            <span class="mlbl" style="overflow:hidden; white-space:nowrap; text-overflow:ellipsis; display:block">${d}</span>
            <span class="v" style="${p?`color:${h.crit}`:""}">${l!==null?l:"--"}<span class="u">${c}</span></span>
          </button>`})}
      </div>
      ${(t.charts??[]).map(s=>{let r=C(this.st(s.entity)),l=this.bad(r,s),c=s.name??this.friendly(s.entity);return o`<div style="margin-top:14px">
          <div style="display:flex; justify-content:space-between; align-items:baseline; margin-bottom:4px">
            <span class="seclbl" style="margin:0">${c}</span>
            ${s.min!==void 0||s.max!==void 0?o`<span style="font:700 12px var(--f-num); color:${l?h.crit:"var(--acc)"}">${s.min??"\u2013"} \u2013 ${s.max??"\u2013"}</span>`:u}
          </div>
          ${H([{data:this._hist[s.entity]??[],color:l?h.crit:h.ok,fill:!0}],{w:this.chartW(),h:96,band:{min:s.min,max:s.max},grid:3})}
        </div>`})}
    </div>`}};customElements.define("growctrl-sensors-card",Xt);var Li=[g.text("title","\u{1F3F7}\uFE0F Titel"),g.num("limit","\u{1F4CB} Max. Zeilen",3,50),g.select("min_level","\u{1F50D} Anzeige",[{value:"alle",label:"Alle Ereignisse"},{value:"warnung",label:"Nur Warnungen/Fehler"},{value:"info",label:"Nur Infos"}])],Ti=[g.entity("entity","\u{1F4DC} Letztes-Ereignis-Sensor","sensor"),g.text("name","\u270F\uFE0F Label (optional)")],Yt=class extends z{render(){return o`${this.form(Li)}
      ${this.list({key:"sources",rowSchema:Ti,title:"\u{1F4E1} Quellen",addLabel:"Quelle hinzuf\xFCgen",newItem:()=>({entity:""})})}
      ${this.styleSection()}
      <div class="hint">Sammelt die Ereignisse mehrerer GROWCTRL-Sensoren in ein Protokoll, neueste zuerst.
        <b>Label</b> ersetzt den Quellennamen. <b>Anzeige</b> kann auf Warnungen/Fehler filtern.</div>`}};customElements.define("growctrl-status-editor",Yt);var Qt=class extends S{static{this.styles=T}validateConfig(e){if(!Array.isArray(e.sources)||!e.sources.length)throw new Error("growctrl-status-card: 'sources' (Letztes-Ereignis-Sensoren) ist Pflicht.")}static getConfigElement(){return document.createElement("growctrl-status-editor")}static getStubConfig(){return{sources:[{entity:"sensor.growctrl_gross_main1_letztes_ereignis"}]}}render(){let e=this._config;if(!this.hass)return u;let t=[],i=[];for(let d of e.sources){let m=this.hass.states[d.entity],f=m?.attributes?.verlauf??[];i.push(m?.attributes?.schweregrad??"ok"),f.forEach((x,y)=>t.push({ts:x.ts,t:typeof x.t=="number"?x.t:void 0,text:x.text,level:x.level,src:d.name??this.friendly(d.entity),entity:d.entity,_i:y}))}t.sort((d,m)=>{let f=d.t??-1,x=m.t??-1;return f!==x?x-f:(m._i??0)-(d._i??0)}),!t.length&&e.sources.every(d=>!this.hass.states[d.entity])&&t.push({ts:"12:30",text:"Licht an (Plan)",level:"info",src:"Station"},{ts:"12:05",text:"VPD im Zielbereich",level:"ok",src:"Station"},{ts:"11:40",text:"Tank niedrig \u2013 bitte nachf\xFCllen",level:"warning",src:"Station"});let s=(e.min_level==="warnung"?t.filter(d=>d.level==="warning"||d.level==="critical"):e.min_level==="info"?t.filter(d=>d.level==="info"):t).slice(0,e.limit??12),r=tt(i),l=e.sources.length>1,c=d=>d==="critical"?"c":d==="warning"?"w":d==="info"?"i":"",p=r==="ok"?this.t("Info"):r==="warning"?this.t("Warnung"):r==="critical"?this.t("Kritisch"):this.t("Info");return o`<div class="card ${e.style?.glass?"glass":""}" data-level=${r} style=${L(e.style)}>
      <div class="hd">
        <div class="ttl grow">${e.title??this.t("Ereignisprotokoll")}</div>
        <span class="pill ${D(r)}">${p}</span>
      </div>
      <div class="log">
        ${s.length?s.map(d=>o`
    ...
    </div>`}};customElements.define("growctrl-status-card",Qt);var Pi=[g.text("title","\u{1F3F7}\uFE0F Titel (optional)"),g.text("logo","\u{1F5BC}\uFE0F Logo-URL (z.B. /local/growctrl/logo.png)"),g.bool("show_chart","\u{1F4C8} 24h-Chart zus\xE4tzlich zum Zonen-Balken"),g.num("hours","\u23F1\uFE0F Chart-Zeitraum (h)",1,168)],Jt=class extends z{render(){let e=[this.stationSelect(this._config?.tent),g.text("name","\u270F\uFE0F Anzeigename (optional)")];return o`${this.form([this.tentSelect("tent","\u{1F3D5}\uFE0F Zelt"),...Pi])}
      ...
      <div class="hint">Die Hero-Karte ist die Zelt-\u00dcbersicht: Klima-Werte, VPD-Skala und das
        Informationssystem. Die gelisteten <b>Stationen</b> liefern die Ereigniszeilen darunter.</div>`}};customElements.define("growctrl-hero-editor",Jt);var Ke=[{w:20,col:"#6E97DE",lbl:"zu feucht"},{w:20,col:"#58E0A5",lbl:"Seedling"},{w:20,col:"#2FB36C",lbl:"Veg"},{w:20,col:"#E5B567",lbl:"Bloom"},{w:20,col:"#D4726F",lbl:"zu trocken"}],te=2,ee=class extends S{constructor(){super(...arguments);this._logoErr=!1;this._hist=[]}static{this.styles=T}static{this.properties={...S.properties,_hist:{state:!0},_logoErr:{state:!0}}}validateConfig(t){if(!t.tent)throw new Error("growctrl-hero-card: 'tent' ist Pflicht (Zelt-Name aus der Integration).")}static getConfigElement(){return document.createElement("growctrl-hero-editor")}static getStubConfig(){return{tent:"gross",stations:[{station:"main1"}]}}te(t){let[i,n,s]=it[t],r=this._config;return r.overrides?.[n]??R(this.hass,r.tent,"zelt",s)??U(i,r.tent,n,r.overrides)}connectedCallback(){super.connectedCallback(),this._load(),this._timer=window.setInterval(()=>this._load(),5*6e4)}disconnectedCallback(){super.disconnectedCallback(),this._timer&&clearInterval(this._timer)}async _load(){if(!this.hass){setTimeout(()=>this._load(),1e3);return}this._hist=await M(this.hass,this.te("vpd"),this._config.hours??24)}tglBtn(t,i,n){return o`<button class="gc tgl ${n?"on":""}" @click=${()=>this.confirmToggle(t,i)}>
      <span class="sw"></span> ${i}</button>`}render(){let t=this._config;if(!this.hass)return u;let i=this.hass.states[this.te("vpd")],n=!i&&!this.hass.states[this.te("enabled")],s=C(i?.state)??(n?.76:null),r=i?.attributes?.temp??(n?21.5:null),l=i?.attributes?.rh??(n?61:null),c=i?.attributes?.phase_effektiv??"",p=i?.attributes?.sollwerte,d=this.isOn(this.te("enabled"))||n,m=this.isOn(this.te("climate")),f=this.hass.states[this.te("status")],x=f?.attributes?.probleme??[],y=(t.stations??[]).map(b=>{let F=this.hass.states[R(this.hass,t.tent,b.station,"last_event")??Z("sensor",t.tent,b.station,"letztes_ereignis",t.overrides)],O=this.hass.states[R(this.hass,t.tent,b.station,"light_rest")??Z("sensor",t.tent,b.station,"licht_restzeit",t.overrides)],B=F?.attributes?.schweregrad??"ok";return{name:b.name??b.station,text:F?.state??"\u2013",level:B,lightText:O?.attributes?.text??(O?.state?`${this.t("Licht")} ${this.t(String(O.attributes?.zustand??""))}`:""),on:O?.attributes?.zustand==="an",ent:R(this.hass,t.tent,b.station,"last_event")??Z("sensor",t.tent,b.station,"letztes_ereignis",t.overrides)}}),$=b=>b==="warning"||b==="critical",v=tt([(f?.state??"").toLowerCase()==="problem"?"warning":"ok",...y.map(b=>$(b.level)?b.level:"ok")]),k=[...x.map(b=>({label:b,level:"warning"})),...y.filter(b=>$(b.level)).map(b=>({label:`${b.name}: ${b.text}`,level:b.level}))],_=s!==null&&p&&s>=p.vpd_min&&s<=p.vpd_max,A=s!==null?Math.min(100,Math.max(0,s/te*100)):null,P=this.isOn(this.te("stale")),w=i?.attributes?.temp_entity||this.te("vpd"),E=i?.attributes?.rh_entity||this.te("vpd");return o`<div class="card ${t.style?.glass?"glass":""}" data-level=${v} style="${L(t.style)};position:relative">
      <div class="hd">
        ...
        <span class="pill ${D(v)}">${v==="ok"?this.t("Alles OK"):v==="warning"?this.t("Warnung"):v==="critical"?this.t("Kritisch"):this.t("Info")}</span>
      </div>
      ...
      <div class="kpis">
        ...
        <button class="gc kpi c-hum" @click=${()=>this.moreInfo(E)}>
      ...
      ${P?o`<div style="margin-top:10px;display:flex;align-items:center;gap:7px;padding:7px 12px;border-radius:10px;
      ...
      <div style="margin-top:16px">
        <div class="zones">
          ${Ke.map(b=>o`<i style="width:${b.w}%;background:${b.col}"></i>`)}
        ...
        <div class="zlbl">${Ke.map(b=>o`<span style="width:${b.w}%">${this.t(b.lbl)}</span>`)}</div>
      </div>

      ${t.show_chart===!0&&this._hist.length>1?o`
        <div class="seclbl">VPD · ${t.hours??24}h</div>
        ${H([{data:this._hist,color:_===!1?h.warn:h.ok,fill:!0}],{w:this.chartW(),h:96,band:p?{min:p.vpd_min,max:p.vpd_max}:void 0,grid:3})}`:u}
      ...
      ${this.renderConfirm()}
    </div>`}};customElements.define("growctrl-hero-card",ee);var ie=class extends z{render(){let e=this._config.tent,t=[this.tentSelect("tent","\u{1F3D5}\uFE0F Zelt"),g.text("title","\u{1F3F7}\uFE0F Titel"),g.bool("show_sensors","\u{1F9EA} Sensoren-Sektion zeigen (pH/EC/Temp/RH/\u2026, Standard an)"),g.bool("show_controls","\u{1F39B}\uFE0F Steuerungs-Sektion zeigen (Licht/Pumpe/\u2026, Standard an)"),g.bool("show_tent_row","\u{1F3D5}\uFE0F Zelt-Sektion zeigen (Aktiv/Klima/VPD/Status)"),g.text("tent_name","\u270F\uFE0F Name der Zelt-Zeile (optional)")],i=[this.stationSelect(e,"station","\u{1F331} Station (= Pflanze)"),g.text("name","\u270F\uFE0F Anzeigename (optional)")];return o`${this.form(t)}
      ...
      <div class="hint">Drei Ampel-Sektionen: <b>Sensoren</b> (pH / EC / Temperatur / Feuchte /
        ...
        <b>grau</b> = kein Wert, <b>leere Zelle</b> = dieser Sensor ist an der Station nicht angelegt. Tippen \u00f6ffnet die Entit\u00e4t.</div>`}};customElements.define("growctrl-checkup-editor",ie);var Fi=[{key:"ph",icon:"mdi:ph",label:"pH",range:"ph",margin:.3},{key:"ec",icon:"mdi:flash-outline",label:"EC",range:"ec",margin:.3},{key:"temp",icon:"mdi:thermometer",label:"Temp",range:null,margin:0},{key:"humidity",icon:"mdi:water-percent",label:"RH",range:null,margin:0},{key:"water_temp",icon:"mdi:coolant-temperature",label:"Wasser",range:null,margin:0},{key:"soil_temp",icon:"mdi:thermometer-low",label:"Boden",range:null,margin:0}],ne=class extends S{static{this.styles=T}validateConfig(e){if(!Array.isArray(e.stations)||!e.stations.length)throw new Error("growctrl-checkup-card: 'stations' (min. 1) ist Pflicht.")}static getConfigElement(){return document.createElement("growctrl-checkup-editor")}static getStubConfig(){return{tent:"gross",show_tent_row:!0,stations:[{station:"main1"},{station:"main2"}]}}sEnt(e,t,i){let[n,s,r]=$t[i];return R(this.hass,e,t,r)??Z(n,e,t,s)}tEnt(e,t){let[i,n,s]=it[t];return R(this.hass,e,"zelt",s)??U(i,e,n)}sensorColsPresent(e){return Fi.filter(t=>e.some(i=>!!(this.hass.states[this.sEnt(i.tent,i.station,"event")]?.attributes?.gc_sensors??{})[t.key]))}sensorCell(e,t,i,n){let r=this.hass.states[this.sEnt(e,t,"event")]?.attributes??{},c=(r.gc_sensors??{})[i.key];if(!c)return{configured:!1,level:"off",title:""};if(n)return{configured:!0,level:"off",title:this.t("gestoppt")};let p=C(this.hass.states[c]?.state);if(p===null)return{configured:!0,level:"off",title:this.t("kein Wert")};let d=null;if(i.range==="ph"?d=r.gc_ph_bereich??null:i.range==="ec"&&(d=r.gc_ec_bereich??null),!d)return{configured:!0,level:"ok",title:`${p}`};let[m,f]=d,x=p>=m&&p<=f,y=p>=m-i.margin&&p<=f+i.margin;return{configured:!0,level:x?"ok":y?"warning":"critical",title:`${i.label} ${p} (${this.t("ideal")} ${m}\u2013${f})`}}avail(e){let t=this.hass.states[e];return!!t&&t.state!=="unavailable"&&t.state!=="unknown"}exists(e){return!!this.hass.states[e]}stationStopped(e,t){let i=this.tEnt(e,"enabled"),n=this.avail(i)&&!this.isOn(i),s=this.hass.states[this.sEnt(e,t,"stage")]?.state==="Aus";return{stopped:n||s,tentOff:n,off:s}}stationCells(e,t){let i=this.sEnt(e,t,"lightRest"),n=this.sEnt(e,t,"pumpRest"),s=this.sEnt(e,t,"heatActive"),r=this.sEnt(e,t,"auto"),l=this.sEnt(e,t,"pOverride"),c=this.sEnt(e,t,"event"),{stopped:p,tentOff:d}=this.stationStopped(e,t),m=d?this.t("Zelt aus \u2013 gestoppt"):this.t("Station aus"),f=(wt,Ye,Qe)=>({present:this.exists(wt),ent:wt,level:p?"off":this.avail(wt)?Ye:"off",text:p?m:Qe}),x=this.hass.states[i],y=x?.attributes?.zustand==="an",$=this.isOn(this.sEnt(e,t,"pFailsafe")),v=this.isOn(this.sEnt(e,t,"pPower"))||this.isOn(this.sEnt(e,t,"pTime")),k=f(i,$?"critical":v?"warning":y?"ok":"off",$?this.t("Licht-Failsafe ausgel\xF6st"):this.isOn(this.sEnt(e,t,"pPower"))?this.t("Licht AN ohne Leistung"):this.isOn(this.sEnt(e,t,"pTime"))?this.t("Lichtzeiten unvollst\xE4ndig"):y?this.t("Licht an"):x?.attributes?.aktiv===!1?this.t("Licht ausgeschaltet"):this.t("Licht aus")),_=this.isOn(this.sEnt(e,t,"pPump")),A=this.hass.states[n],P=f(n,_?"critical":A?.attributes?.aktiv===!1?"off":"ok",_?this.t("Pumpe gesperrt (F\xFCllstand)"):A?.attributes?.aktiv===!1?this.t("Pumpe ausgeschaltet"):A?.attributes?.text??this.t("Zyklus l\xE4uft")),w=this.isOn(this.sEnt(e,t,"heatSensorFault")),E=this.isOn(this.sEnt(e,t,"heatOvertemp")),b=this.isOn(this.sEnt(e,t,"heatEnabled")),F=this.hass.states[s],O=F?.state==="on",B=F?.attributes??{},nt=f(s,w||E?"critical":b?"ok":"off",w?this.t("Heizung Sensorfehler"):E?this.t("Heizung \xDCbertemperatur"):b?O?`${this.t("Heizung heizt")}${typeof B.ist_temp=="number"?` \xB7 ${B.ist_temp} \xB0C`:""}`:this.t("Heizung bereit"):this.t("Heizung aus")),ut=this.isOn(r),ht=this.isOn(this.sEnt(e,t,"wartung")),je=f(r,ht?"info":ut?"ok":"warning",ht?this.t("Wartungsmodus aktiv"):ut?this.t("Automatik AN"):this.t("Automatik AUS (manuell)")),ue=this.isOn(l),qe=f(l,ue?"warning":"ok",ue?this.t("Manueller Eingriff aktiv"):this.t("Kein Eingriff")),he=this.hass.states[c],ge=he?.attributes?.schweregrad??"ok",Xe={present:!0,ent:c,keepClick:!0,level:p?"off":ge==="critical"?"critical":ge==="warning"?"warning":"ok",text:p?m:he?.state??"OK"};return{licht:k,pumpe:P,heizung:nt,auto:je,eingriff:qe,status:Xe}}tentCells(e){let t=this.isOn(this.tEnt(e,"enabled")),i=t?"ok":"warning",n=t?this.t("Zelt aktiv"):this.t("Zelt deaktiviert"),s=this.isOn(this.tEnt(e,"climate")),r=s?"ok":"off",l=s?this.t("Klima-Automatik AN"):this.t("Klima-Automatik AUS"),c=this.hass.states[this.tEnt(e,"vpd")],p=C(c?.state),d=c?.attributes?.sollwerte,m=p!==null&&d?p>=d.vpd_min&&p<=d.vpd_max?"ok":"warning":c?"ok":"off",f=p!==null?`VPD ${p.toFixed(2)} kPa${d?` (${this.t("Soll")} ${d.vpd_min}\u2013${d.vpd_max})`:""}`:"\u2014",x=this.hass.states[this.tEnt(e,"status")],y=(x?.state??"").toLowerCase()==="problem",$=x?.attributes?.probleme??[],v=y?"warning":"ok",k=y?$[0]??this.t("Problem erkannt"):this.t("Alles OK");return{aktiv:i,klima:r,vpd:m,status:v,aktivText:n,klimaText:l,vpdText:f,statusText:k,ent:{aktiv:this.tEnt(e,"enabled"),klima:this.tEnt(e,"climate"),vpd:this.tEnt(e,"vpd"),status:this.tEnt(e,"status")}}}dot(e){return o`<span class="dot ${e==="off"?"off":D(e)}"></span>`}mc(e,t,i){return o`<button class="gc mc" title=${t} @click=${()=>i&&this.moreInfo(i)}>${this.dot(e)}</button>`}pCell(e,t){return e.configured?e.level==="off"?o`<span class="mc" style="cursor:default">${this.dot("off")}</span>`:this.mc(e.level,e.title,t):o`<span class="mc" style="cursor:default"></span>`}cCell(e){return e.present?e.level==="off"&&!e.keepClick?o`<span class="mc" style="cursor:default" title=${e.text}>${this.dot("off")}</span>`:this.mc(e.level,e.text,e.ent):o`<span class="mc" style="cursor:default"></span>`}mh(e,t){return o`<span class="mh" title=${this.t(t)}><ha-icon icon=${e}></ha-icon></span>`}mClass(e){return e===4?"m4":e===5?"m5":e===6?"m6":""}gridStyle(e){return this.mClass(e)?"":`grid-template-columns:1fr repeat(${e}, minmax(0,46px))`}render(){let e=this._config;if(!this.hass)return u;let t=(e.stations??[]).map(v=>({tent:v.tent??e.tent??"gross",station:v.station,name:v.name??v.station})),i=e.tent??t[0]?.tent??"gross",n=e.show_tent_row!==!1,s=e.show_sensors!==!1,r=e.show_controls!==!1,l=[],c=s?this.sensorColsPresent(t):[],p=c.length?t.map(v=>{let k=this.stationStopped(v.tent,v.station).stopped,_=c.map(A=>({col:A,cell:this.sensorCell(v.tent,v.station,A,k)}));return _.forEach(A=>{A.cell.configured&&A.cell.level!=="off"&&l.push(A.cell.level)}),{...v,cells:_}}):[],d=t.some(v=>!!this.hass.states[this.sEnt(v.tent,v.station,"heatActive")]),m=r?t.map(v=>{let k=this.stationCells(v.tent,v.station);return[k.status,k.pumpe,k.licht,k.auto,k.eingriff,...d?[k.heizung]:[]].forEach(_=>{_.present&&_.level!=="off"&&l.push(_.level)}),{...v,cells:k}}):[],f=n?this.tentCells(i):null;f&&l.push(f.status,f.aktiv,f.vpd);let x=tt(l),y=c.length,$=d?6:5;return o`<div class="card ${e.style?.glass?"glass":""}" data-level=${x} style=${L(e.style)}>
      <div class="hd">
        <div class="grow">
        ...
        <span class="pill ${D(x)}">${x==="ok"?this.t("Alles OK"):x==="warning"?this.t("Warnung"):x==="critical"?this.t("Kritisch"):this.t("Info")}</span>
      </div>
    ...
    </div>`}};customElements.define("growctrl-checkup-card",ne);var Mi=[g.text("title","\u{1F3F7}\uFE0F Titel"),g.entity("entity","\u{1F4A7} F\xFCllstand-Sensor (%) (Pflicht)","sensor"),g.num("min","\u26A0\uFE0F Mindeststand (%)",0,100),g.num("volume_l","\u{1FAA3} Tankvolumen (Liter, optional)",0,2e3)],se=class extends z{render(){return o`${this.form(Mi)}${this.styleSection()}
      <div class="hint">Der <b>F\u00fcllstand-Sensor</b> liefert Prozent. Unter dem <b>Mindeststand</b> wird der
        Tank rot. Mit <b>Tankvolumen</b> zeigt die Karte zus\u00e4tzlich die ungef\u00e4hren Liter an.</div>`}};customElements.define("growctrl-tank-editor",se);var re=class extends S{constructor(){super(...arguments);this._tankHist=[]}static{this.styles=T}static{this.properties={...S.properties,_tankHist:{state:!0}}}validateConfig(t){if(!t.entity)throw new Error("growctrl-tank-card: 'entity' (Fuellstand-Sensor in %) ist Pflicht.")}static getConfigElement(){return document.createElement("growctrl-tank-editor")}static getStubConfig(){return{entity:"sensor.gc_slot1_level1",title:"Tank",min:30,volume_l:200}}connectedCallback(){super.connectedCallback(),this._load(),this._timer=window.setInterval(()=>this._load(),5*6e4)}disconnectedCallback(){super.disconnectedCallback(),this._timer&&clearInterval(this._timer)}async _load(){if(!this.hass){setTimeout(()=>this._load(),1e3);return}let t=this._config.entity;if(t){let i=await M(this.hass,t,72);i.length&&(this._tankHist=i)}}daysLeft(t,i){let n=this._tankHist;if(!n||n.length<4||t<=i)return null;let s=0;for(let l=1;l<n.length;l++){let c=n[l-1]-n[l];c>0&&(s+=c)}let r=s/(72/24);return r<.4?null:(t-i)/r}render(){let t=this._config;if(!this.hass)return u;let i=!this.hass.states[t.entity],n=Math.min(100,Math.max(0,C(this.st(t.entity))??(i?49:0))),s=t.min!==void 0&&n<t.min,r=s?h.crit:h.water,l=t.volume_l?n/100*t.volume_l:null,c=t.min!==void 0&&!i?this.daysLeft(n,t.min):null,p=c===null?"":c<1?`<1 ${this.t("Tag")}`:`~${Math.round(c)} ${this.t("Tage")}`;return o`<div class="card ${t.style?.glass?"glass":""}" data-level=${s?"critical":"ok"} style=${L(t.style)}>
      <div class="hd">
      ...
      <div style="display:flex; gap:18px; align-items:center">
        <button class="gc tankv" @click=${()=>this.moreInfo(t.entity)}>
          ...
          <span class="fill" style="height:${n}%; background:linear-gradient(180deg, ${r}d9, ${r}80)"></span>
        </button>
        <button class="gc" style="flex:1; min-width:0; text-align:left" @click=${()=>this.moreInfo(t.entity)}>
          ...
          ${l!==null?o`<div style="margin-top:6px; font:700 12.5px var(--f-ui); color:var(--tx-2)">≈ ${l.toFixed(1)} l von ${t.volume_l} l</div>`:u}
    ...
    </div>`}};customElements.define("growctrl-tank-card",re);var Ri=[g.text("title","\u{1F3F7}\uFE0F Titel"),g.num("hours","\u23F1\uFE0F Zeitraum (h)",1,168),g.num("height","\u{1F4CF} Diagrammh\xF6he (px)",80,300)],Oi=[g.entity("entity","\u{1F4C8} Sensor","sensor"),g.text("name","\u270F\uFE0F Anzeigename (optional)"),g.select("axis","\u{1F4CA} Achse",[{value:"left",label:"Links (Standard)"},{value:"right",label:"Rechts (zweite Achse)"}]),g.text("color","\u{1F3A8} Farbe (optional, z.B. #FF9F5A)")],ae=class extends z{render(){return o`${this.form(Ri)}
      ${this.list({key:"sensors",rowSchema:Oi,title:"\u{1F4C9} Serien",addLabel:"Sensor hinzuf\xFCgen",newItem:()=>({entity:""})})}
      ${this.styleSection()}
      <div class="hint">Mehrere Serien werden in ein Diagramm gezeichnet (z.B. Temperatur + Luftfeuchte).
        ...
        <b>Farbe</b> als Hex-Wert; ohne Angabe automatisch.</div>`}};customElements.define("growctrl-history-editor",ae);var Ge=["#FFB98A","#7CC8F0","#7BE8A8","#C3ABF5"],Bi=(a,e,t)=>Array.from({length:48},(i,n)=>+(a+e*Math.sin(n/47*Math.PI*2+t)).toFixed(1)),oe=class extends S{constructor(){super(...arguments);this._hist={};this._hidden=new Set}static{this.styles=T}static{this.properties={...S.properties,_hist:{state:!0},_hidden:{state:!0}}}_toggle(t){let i=new Set(this._hidden);i.has(t)?i.delete(t):i.add(t),this._hidden=i}validateConfig(t){if(!Array.isArray(t.sensors)||!t.sensors.length)throw new Error("growctrl-history-card: 'sensors' (min. 1 Eintrag) ist Pflicht.")}static getConfigElement(){return document.createElement("growctrl-history-editor")}static getStubConfig(){return{hours:24,sensors:[{entity:"sensor.demo_temp",name:"Temperatur"},{entity:"sensor.demo_hum",name:"Feuchte"}]}}connectedCallback(){super.connectedCallback(),this._load(),this._timer=window.setInterval(()=>this._load(),5*6e4)}disconnectedCallback(){super.disconnectedCallback(),this._timer&&clearInterval(this._timer)}async _load(){if(!this.hass){setTimeout(()=>this._load(),1e3);return}let t=this._config,i={};for(let n of t.sensors)i[n.entity]=await M(this.hass,n.entity,t.hours??24);this._hist=i}render(){let t=this._config;if(!this.hass)return u;let i=t.sensors.map((l,c)=>({entity:l.entity,data:this._hist[l.entity]?.length?this._hist[l.entity]:this.hass.states[l.entity]?[]:Bi(c===0?22:58,c===0?3:6,c),color:l.color??Ge[c%Ge.length],name:l.name??this.friendly(l.entity),axis:l.axis})),n=i.filter(l=>!this._hidden.has(l.entity)),s=n.length===1,r=n.map(l=>({data:l.data,color:l.color,name:l.name,axis:l.axis,fill:s}));return o`<div class="card ${t.style?.glass?"glass":""}" style=${L(t.style)}>
      <div class="hd">
      ...
      <div class="legend">
        ${i.map(l=>{let c=this._hidden.has(l.entity);return o`<button @click=${()=>this._toggle(l.entity)}
            ...
            <i style="width:10px;height:3px;border-radius:2px;background:${l.color};display:inline-block;${c?"filter:grayscale(1)":""}"></i>${l.name} · ${C(this.st(l.entity))??"--"} ${this.unit(l.entity)}</button>`})}
      </div>
    </div>`}};customElements.define("growctrl-history-card",oe);var Ii=[g.text("title","\u{1F3F7}\uFE0F Titel"),g.entity("entity","\u{1F4C8} Sensor (Pflicht)","sensor"),g.text("name","\u270F\uFE0F Anzeigename (optional)"),g.num("min","Sollbereich Min"),g.num("max","Sollbereich Max"),g.num("decimals","\u{1F522} Nachkommastellen",0,4),g.num("hours","\u23F1\uFE0F Chart-Zeitraum (h)",1,168),g.num("height","\u{1F4CF} Diagrammh\xF6he (px)",80,300)],le=class extends z{render(){return o`${this.form(Ii)}${this.styleSection()}
      <div class="hint">Zeigt einen Messwert gro\u00df mit Sollbereich und Verlauf. Ideal f\u00fcr <b>EC</b> oder
        <b>pH</b>. Liegt der Wert au\u00dferhalb von Min/Max, f\u00e4rbt sich die Anzeige als Warnung.</div>`}};customElements.define("growctrl-metric-editor",le);var ce=class extends S{constructor(){super(...arguments);this._hist=[]}static{this.styles=T}static{this.properties={...S.properties,_hist:{state:!0}}}validateConfig(t){if(!t.entity)throw new Error("growctrl-metric-card: 'entity' ist Pflicht.")}static getConfigElement(){return document.createElement("growctrl-metric-editor")}static getStubConfig(){return{entity:"sensor.gc_slot1_ec1",name:"EC",min:1.2,max:2.2}}connectedCallback(){super.connectedCallback(),this._load(),this._timer=window.setInterval(()=>this._load(),5*6e4)}disconnectedCallback(){super.disconnectedCallback(),this._timer&&clearInterval(this._timer)}async _load(){if(!this.hass){setTimeout(()=>this._load(),1e3);return}let t=this._config;this._hist=await M(this.hass,t.entity,t.hours??24)}render(){let t=this._config;if(!this.hass)return u;let i=C(this.st(t.entity))??(this.hass.states[t.entity]?null:1.84),n=i!==null&&t.min!==void 0&&i<t.min,s=i!==null&&t.max!==void 0&&i>t.max,r=n||s,l=i===null?"var(--tx-3)":r?h.crit:h.ok,c=t.decimals??2,p=t.min!==void 0||t.max!==void 0;return o`<div class="card ${t.style?.glass?"glass":""}" data-level=${r?"warning":"ok"} style=${L(t.style)}>
      <div class="hd">
        <div class="grow" style="min-width:0">
      ...
      <div style="margin-top:6px">
        ${H([{data:this._hist,color:r?h.crit:h.ok,fill:!0}],{w:this.chartW(),h:t.height??104,band:{min:t.min,max:t.max},grid:3})}
      </div>
    </div>`}};customElements.define("growctrl-metric-card",ce);var Hi=[g.text("title","\u{1F3F7}\uFE0F Titel"),g.num("columns","\u25A6 Spalten",1,4)],Ni=[g.text("label","\u270F\uFE0F Beschriftung"),g.text("icon","\u{1F3A8} Icon (z.B. mdi:lightbulb-off)"),g.text("service","\u26A1 Service (z.B. light.turn_off)"),{name:"data",label:"\u{1F4E6} Service-Daten (optional, YAML/JSON)",selector:{object:{}}},g.bool("confirm","\u2705 Vor dem Ausf\xFChren best\xE4tigen")],pe=class extends z{render(){return o`${this.form(Hi)}
      ${this.list({key:"buttons",rowSchema:Ni,title:"\u26A1 Aktionen (Buttons)",addLabel:"Aktion hinzuf\xFCgen",newItem:()=>({label:"",service:""})})}
      ${this.styleSection()}
      <div class="hint">Jeder Button ruft einen <b>Service</b> auf. Beispiele:
        ...
        Mit Best\u00e4tigung wird vor dem Ausf\u00fchren nachgefragt.</div>`}};customElements.define("growctrl-actions-editor",pe);var de=class extends S{static{this.styles=T}validateConfig(e){if(!Array.isArray(e.buttons)||!e.buttons.length)throw new Error("growctrl-actions-card: 'buttons' (min. 1 Eintrag) ist Pflicht.")}static getConfigElement(){return document.createElement("growctrl-actions-editor")}static getStubConfig(){return{title:"Schnellaktionen",columns:2,buttons:[{label:"Alle Lichter aus",icon:"mdi:lightbulb-off",service:"light.turn_off",confirm:!0},{label:"Konfig-Backup",icon:"mdi:content-save-cog",service:"growctrl.export_config"}]}}run(e){let[t,i]=(e.service??"").split(".");!t||!i||this.hass.callService(t,i,e.data&&typeof e.data=="object"?e.data:{})}tap(e){e.confirm?this._confirm={text:`${e.label}?`,action:()=>this.run(e)}:this.run(e)}render(){let e=this._config;if(!this.hass)return u;let t=e.columns??2;return o`<div class="card ${e.style?.glass?"glass":""}" style="${L(e.style)};position:relative">
      ${e.title?o`<div class="hd"><div class="ttl">${e.title}</div></div>`:u}
      <div class="acts" style="grid-template-columns:repeat(${t},minmax(0,1fr))">
        ${e.buttons.map(i=>o`<button class="gc act" style="position:relative"
            title=${i.confirm?"Fragt vor dem Ausf\xFChren nach":i.label}
            @click=${()=>this.tap(i)}>
          ${i.confirm?o`<ha-icon icon="mdi:lock" style="position:absolute;top:6px;right:6px;--mdc-icon-size:12px;color:var(--tx-3)"></ha-icon>`:u}
          <ha-icon class="aic" icon="${i.icon||"mdi:flash"}" style="--mdc-icon-size:18px"></ha-icon>
          <span class="anm">${i.label}</span>
        </button>`)}
      </div>
      ${this.renderConfirm()}
    </div>`}};customElements.define("growctrl-actions-card",de);var Di="4.4.0",Vi=[{type:"growctrl-tent-card",name:"GROWCTRL Tent",description:"Zelt-Hero: Klima-KPIs, VPD-Skala, Status-Ampel"},{type:"growctrl-station-card",name:"GROWCTRL Station",description:"Station: Licht-/Pumpenbalken, Stage, Auto, Konfiguration"},{type:"growctrl-controls-card",name:"GROWCTRL Controls",description:"Aktoren-Raster mit Gruppen und Bestaetigung"},{type:"growctrl-sensors-card",name:"GROWCTRL Sensors",description:"Sensor-KPIs mit Sollbereich-Ampel"},{type:"growctrl-status-card",name:"GROWCTRL Status",description:"Ereignisprotokoll der Integration mit Schweregrad-Ampel"},{type:"growctrl-hero-card",name:"GROWCTRL Hero",description:"Globale Steuerung, Klima-KPIs, VPD-Chart, Informationssystem"},{type:"growctrl-checkup-card",name:"GROWCTRL Checkup",description:"Checkup-Matrix: Licht/Pumpe/Klima/Status je Station"},{type:"growctrl-tank-card",name:"GROWCTRL Tank",description:"DWC-Fuellstand (vertikaler Tank) mit Warnstufe"},{type:"growctrl-history-card",name:"GROWCTRL History",description:"24h-Diagramm (z.B. Temperatur + Luftfeuchte)"},{type:"growctrl-metric-card",name:"GROWCTRL Metric",description:"EC/pH gross mit Chart und Sollbereich"},{type:"growctrl-actions-card",name:"GROWCTRL Actions",description:"Schnell-Aktionen: konfigurierbare Buttons, rufen Services auf"}];window.customCards=window.customCards??[];window.__gcEpoch=Re();Vi.forEach(a=>window.customCards.push({...a,preview:!0,documentationURL:"https://github.com/MrDarkvoid/growctrl"}));console.info(`%c GROWCTRL Cards %c v${Di} `,"background:#1D9E75;color:#fff;font-weight:700","background:#0F6E56;color:#fff");
