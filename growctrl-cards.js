    ...
    <circle cx="${g}" cy="${f}" r="2.6" fill="${e}"/>
      ...
      <div class="hd">
        <div class="grow" style="min-width:0">
          ...
          <div class="sub" style="display:flex;align-items:center;gap:7px;flex-wrap:wrap">
      ...
      ${this.renderConfirm()}
    </div>`}};customElements.define("growctrl-hero-card",ne);var ie=class extends L{render(){let e=this._config.tent,t=[this.tentSelect("tent","\u{1F3D5}\uFE0F Zelt"),h.text("title","\u{1F3F7}\uFE0F Titel"),h.bool("show_sensors","\u{1F9EA} Sensoren-Sektion zeigen (pH/EC/Temp/RH/\u2026, Standard an)",!0),h.bool("show_controls","\u{1F39B}\uFE0F Steuerungs-Sektion zeigen (Licht/Pumpe/\u2026, Standard an)",!0),h.bool("show_tent_row","\u{1F3D5}\uFE0F Zelt-Sektion zeigen (Aktiv/Klima/VPD/Status)",!0),h.text("tent_name","\u270F\uFE0F Name der Zelt-Zeile (optional)")],n=[this.stationSelect(e,"station","\u{1F331} Station (= Pflanze)"),h.text("name","\u270F\uFE0F Anzeigename (optional)")];return c`${this.form(t)}
